 ...
 *
 * @Functionality:
 *    Build  Config rsp as per 5G nFAPI Specification 3.1.2 CONFIG.response
 *    And Send to VNF
 *
 * *******************************************************************************/
...
uint8_t buildAndSendConfigResp()
{
   ...
   //As per 5G nFAPI Specification, section 3.2.2 CONFIG.response
   CMCHKPK(oduPackPostUInt8, 0, mBuf);  //Error Code
 ...
 *
 * @Functionality:
 *    Build  Start rsp as per 5G nFAPI Specification 3.1.2 START.response
 *    And Send to VNF
 *
 *
 *******************************************************************************/
