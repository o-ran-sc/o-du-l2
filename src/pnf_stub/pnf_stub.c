...
{
    CMCHKPK(oduPackPostUInt16, 120, mBuf);
    CMCHKPK(oduPackPostUInt8, 0, mBuf);
    CMCHKPK(oduPackPostUInt8, 10, mBuf);
...
{
    CMCHKPK(oduPackPostUInt8, 2, mBuf);
    CMCHKPK(oduPackPostUInt8, 5, mBuf);
    CMCHKPK(oduPackPostUInt16, msgId, mBuf);
    CMCHKPK(oduPackPostUInt32, 123, mBuf);
