...
{
   pair<map<int,Alarm>::iterator,bool> ret;
   ret = mAlarmList.insert(pair<int,Alarm>(alarm.getAlarmId(),alarm));
   return ret.second;
}
...
/********************************************************************** 
   ...
   Return      : true  - delete successful
                 false - delete unsuccessful 
**********************************************************************/
bool AlarmManager::clearAlarm(const int& alarmId)
{
...
**********************************************************************/
const map<int, Alarm>& AlarmManager::getAlarmList()const
{
   return mAlarmList;
}
