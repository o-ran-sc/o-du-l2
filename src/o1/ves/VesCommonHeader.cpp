...
string VesCommonHeader::getEventId()
{
  /*Currently PNF_REGISTRATION only supported. This function must be updated
   ...
   {
      case VesEventType::PNF_REGISTRATION:
         evntId = getEventTypeToStr() + "_" + getNamingCode();
         break;
      case VesEventType::HEARTBEAT:
  ...
  /*Currently PNF_REGISTRATION only supported. This function must be updated
   ...
   switch(mEventType)
   {
      ...
      case VesEventType::HEARTBEAT:
         ...
         break;
      default:
         O1_LOG("\nO1 VES : This VES msg Type support in getEventName is \
not available");
         break;
   }
   return evntName;
  ...
  /*Currently PNF_REGISTRATION only supported. This function must be updated
   ...
   switch(mEventType)
   {
      case VesEventType::PNF_REGISTRATION:
         ...
         break;
      default:
         O1_LOG("\nO1 VES : This VES msg Type support in \
...
uint64_t VesCommonHeader::getEpochTime()
{
    uint64_t epochTimeInMicrosec = std::chrono::duration_cast \
            ...
            (st d::chrono::system_clock::now().time_since_epoch()).count();
