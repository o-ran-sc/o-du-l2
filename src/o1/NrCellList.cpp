 ...
 *         false  - failure
 ******************************************************************/
bool NrCellList::setAdminState(uint16_t cellId, AdminState newAdminState)
{
...
std::map<uint16_t, NrCellInfo> & NrCellList::getCellOpStateList()
//NrCellList::CellOpStateMap & NrCellList::getCellOpStateList()
{
