...
uint8_t readMacCfg()
{
   ...
   for(sliceIdx=0; sliceIdx<taiSliceSuppLst->numSupportedSlices && sliceIdx<MAX_NUM_OF_SLICES; sliceIdx++)
   {
...
uint8_t readCfg()
{
   ...
   Snssai snssai[ODU_SUPPORTED_SLICE] = {{1,{2,3,4}},{5,{6,7,8}}};
   ...
   { 
      ...
      for(srvdPlmnIdx=0; srvdPlmnIdx<MAX_PLMN; srvdPlmnIdx++)
      {
         ...
         taiSliceSuppLst->numSupportedSlices = ODU_SUPPORTED_SLICE;
