...
uint8_t readMacCfg()
{
   ...
   duCfgParam.macCellCfg.dlCarrCfg.bw = duCfgParam.macCellCfg.dlCarrCfg.bw;
   duCfgParam.macCellCfg.ulCarrCfg.freq =  duCfgParam.srvdCellLst[0].duCellInfo.f1Mode.mode.fdd.ulNrFreqInfo.nrArfcn;
