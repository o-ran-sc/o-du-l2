...
uint8_t cpyRrmPolicyInDuCfgParams(RrmPolicyList rrmPolicy[], uint8_t policyNum, MacSliceCfgReq *tempSliceCfg)
{
   ...
   if(policyNum)
   {
      ...
      for(policyIdx = 0; policyIdx<tempSliceCfg->numOfRrmPolicy; policyIdx++)
      {
         ...
         tempSliceCfg->listOfRrmPolicy[policyIdx]->rRMMemberNum = rrmPolicy[policyIdx].rRMMemberNum;
         ...
         if(tempSliceCfg->listOfRrmPolicy[policyIdx]->rRMMemberNum)
         {
            ...
            tempSliceCfg->listOfRrmPolicy[policyIdx]->rRMMemberNum * sizeof(RrmPolicyMemberList*));
