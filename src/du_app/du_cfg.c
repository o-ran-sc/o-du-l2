...
S16 readMacCfg()
{
   ...
   duCfgParam.macCellCfg.ssbCfg.ssbOffsetPointA = PRB_OFFSET;
   ...
   duCfgParam.macCellCfg.ssbCfg.ssbMask[0] = 2162721;
   ...
   *(duCfgParam.macCellCfg.prachCfg.fdm[0].unsuedRootSeq) = UNUSED_ROOT_SEQ;
   ...
   duCfgParam.macCellCfg.sib1Cfg.sib1PduLen = 95;
   duCfgParam.macCellCfg.sib1Cfg.sib1NewTxPeriod = 160;
   duCfgParam.macCellCfg.sib1Cfg.sib1RepetitionPeriod = 20;
   duCfgParam.macCellCfg.sib1Cfg.coresetZeroIndex = 0;
   duCfgParam.macCellCfg.sib1Cfg.searchSpaceZeroIndex = 0;
   duCfgParam.macCellCfg.sib1Cfg.sib1Mcs = 4;
