...
uint8_t BuildRachConfigDedicated(DuUeCb *ueCb, struct ReconfigurationWithSync__rach_ConfigDedicated *rachCfgDed)
{
   ...
   *(cfra->occasions->ssb_perRACH_Occasion) = convertCFRASsbPerRachOccasionValueToEnum(duRachCfg.numSsbPerRachOcc);
   ...
   listIdx = 0;
   ssbResource->ssb_ResourceList.list.array[listIdx]->ssb = 0;
   ssbResource->ssb_ResourceList.list.array[listIdx]->ra_PreambleIndex = 8;
