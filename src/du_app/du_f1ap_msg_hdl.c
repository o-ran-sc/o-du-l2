 ...
 * @details
 *
 *    Function : fillLongCycleOffsetVal 
 *
 ...
 *
 * ****************************************************************/
void fillLongCycleOffsetVal(DrxLongCycleStartOffset  drxLongCycleStartOffset,\
struct DRX_ConfigRrc__drx_LongCycleStartOffset *drx_LongCycleStartOffset)
{
...
uint8_t BuildDrxConfigRrc(DuUeCb *ueCb, struct MAC_CellGroupConfig__drx_ConfigRrc *drxCfg)
{
   ...
   if(ueCb->macUeCfg.macCellGrpCfg.drxCfg.drxOnDurationTimer.onDurationTimerValInMs)
   {
      ...
      drxCfg->choice.setup->drx_onDurationTimer.choice.milliSeconds = ueCb->macUeCfg.macCellGrpCfg.drxCfg.\
      drxOnDurationTimer.onDurationtimerValue.milliSeconds;
   }
   else
   {
   ...
   drxCfg->choice.setup->drx_InactivityTimer = ueCb->macUeCfg.macCellGrpCfg.drxCfg.drxInactivityTimer;
   ...
   drxCfg->choice.setup->drx_RetransmissionTimerDL = ueCb->macUeCfg.macCellGrpCfg.drxCfg.drxRetransmissionTimerDl;
   drxCfg->choice.setup->drx_RetransmissionTimerUL = ueCb->macUeCfg.macCellGrpCfg.drxCfg.drxRetransmissionTimerDl;
   drxCfg->choice.setup->drx_SlotOffset = ueCb->macUeCfg.macCellGrpCfg.drxCfg.drxSlotOffset;
   fillLongCycleOffsetVal(ueCb->macUeCfg.macCellGrpCfg.drxCfg.drxLongCycleStartOffset, &drxCfg->choice.setup->drx_LongCycleStartOffset);
