...
uint8_t BuildAndSendRrcDeliveryReport( DuUeCb  ueCb, uint8_t lcId)
{
   uint8_t             ret = RFAILED;
   uint8_t             idx    = 0;
   uint8_t             idx1   = 0;
   ...
   while(true){
	 ...
	 if(RrcDeliveryMsg->protocolIEs.list.array[idx] == NULLP)
	 {
      ...
      RrcDeliveryMsg->protocolIEs.list.array[idx1]->value.choice.RRCDeliveryStatus.delivery_status = lcId;
      RrcDeliveryMsg->protocolIEs.list.array[idx1]->value.choice.RRCDeliveryStatus.triggering_message = lcId;
      ...
      RrcDeliveryMsg->protocolIEs.list.array[idx1]->value.choice.SRBID = 1 ;
