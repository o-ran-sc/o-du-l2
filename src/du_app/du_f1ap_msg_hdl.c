...
void extractRlcUmBiCfg(UmBiDirBearerCfg *umBiCfgToSet, struct RLC_Config__um_Bi_Directional *rlcBiCfg)
{
   if(rlcBiCfg)
   {
      ...
      {
	 umBiCfgToSet->ulUmCfg.snLenUlUm  = covertUmSnLenFromToRrcEnumToIntEnum(*(rlcBiCfg->dl_UM_RLC.sn_FieldLength));
	 ...
	 umBiCfgToSet->dlUmCfg.snLenDlUm  = covertUmSnLenFromToRrcEnumToIntEnum(*(rlcBiCfg->ul_UM_RLC.sn_FieldLength));
   }
}
...
void extractRlcUmUlCfg(UmUniDirUlBearerCfg *umUlCfgToSet, struct RLC_Config__um_Uni_Directional_DL *umUlCfg)
{
   if(umUlCfg)
   {
      ...
      {
         umUlCfgToSet->ulUmCfg.snLenUlUm  = covertUmSnLenFromToRrcEnumToIntEnum(*(umUlCfg->dl_UM_RLC.sn_FieldLength));
...
void extractRlcUmDlCfg(UmUniDirDlBearerCfg *umDlCfgToSet, struct RLC_Config__um_Uni_Directional_UL *umDlCfg)
{
   if(umDlCfg)
   {
      if(umDlCfg->ul_UM_RLC.sn_FieldLength)
         umDlCfgToSet->dlUmCfg.snLenDlUm  = covertUmSnLenFromToRrcEnumToIntEnum(*(umDlCfg->ul_UM_RLC.sn_FieldLength));
   }
}
