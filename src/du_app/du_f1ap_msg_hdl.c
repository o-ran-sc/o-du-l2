...
void freeRrcDeliveryReport(F1AP_PDU_t  *f1apMsg )
{
    ...
    if(f1apMsg)
    {
	  ...
	  {
	     for(idx =0 ;idx <RrcDeliveryMsg->protocolIEs.list.count ; idx++)
	     {
	        if(RrcDeliveryMsg->protocolIEs.list.array[idx])
		{
	           DU_FREE(RrcDeliveryMsg->protocolIEs.list.array[idx], sizeof(RRCDeliveryReportIEs_t));
		}   
	     }
	     DU_FREE(RrcDeliveryMsg->protocolIEs.list.array, RrcDeliveryMsg->protocolIEs.list.size);
	  }
          DU_FREE(f1apMsg->choice.initiatingMessage,sizeof(InitiatingMessage_t));
       }
       DU_FREE(f1apMsg, sizeof(F1AP_PDU_t));
...
uint8_t BuildAndSendRrcDeliveryReport(DuUeCb  ueCb)
{
   uint8_t             ret = RFAILED;
   uint8_t             idx    = 0;
   uint8_t             idx1   = 0;
   ...
   while(true){
	 ...
	 if(RrcDeliveryMsg->protocolIEs.list.array[idx] == NULLP)
	 {
      ...
      RrcDeliveryMsg->protocolIEs.list.array[idx1]->value.choice.GNB_CU_UE_F1AP_ID = ueCb.gnbCuUeF1apId;
      ...
      RrcDeliveryMsg->protocolIEs.list.array[idx1]->value.choice.GNB_DU_UE_F1AP_ID = ueCb.gnbDuUeF1apId;
      ...
      RrcDeliveryMsg->protocolIEs.list.array[idx1]->value.choice.RRCDeliveryStatus.delivery_status = PDCP_SN;
      RrcDeliveryMsg->protocolIEs.list.array[idx1]->value.choice.RRCDeliveryStatus.triggering_message = PDCP_SN;
      ...
      RrcDeliveryMsg->protocolIEs.list.array[idx1]->value.choice.SRBID = SRB_ID_1;
