...
int8_t getReAsmblTmr(uint8_t reAsmblTmrCfg)
{
   ...
   {
      switch(reAsmblTmrCfg)
      {
         case T_Reassembly_ms110:
            reAsmblTmr = 110;
            break;
         case T_Reassembly_ms120:
            reAsmblTmr = 120;
            break;
         case T_Reassembly_ms130:
            reAsmblTmr = 130;
            break;
         case T_Reassembly_ms140:
            reAsmblTmr = 140;
            break;
         case T_Reassembly_ms150:
            reAsmblTmr = 150;
            break;
         case T_Reassembly_ms160:
            reAsmblTmr = 160;
            break;
         case T_Reassembly_ms170:
            reAsmblTmr = 170;
            break;
         case T_Reassembly_ms180:
            reAsmblTmr = 180;
            break;
         case T_Reassembly_ms190:
            reAsmblTmr = 190;
            break;
         case T_Reassembly_ms200:
            reAsmblTmr = 200;
            break;
         default:
            DU_LOG("\nInvalid value of Re Assembly timer");
            reAsmblTmr = -1;
	    break;
      }
   }
   ...
   else
   {
      switch(statProhTmrCfg)
      {
         ...
         case T_StatusProhibit_ms2400:
            ...
            break;
         default:
            DU_LOG("\nInvalid value of Status Prohibit timer");
            statProhTmr = -1;
	    break;
      }
   }
