...
uint8_t BuildFreqInfoUlret = RFAILED;
uint8_t BuildRachCfgCommonret = RFAILED;
uint8_t BuildPuschCfgCommonret = RFAILED;
uint8_t BuildUlCfgCommSibret = RFAILED;
uint8_t BuildFreqInfoDlret = RFAILED;
uint8_t BuildDlCfgCommSibret = RFAILED;
uint8_t BuildCommonSerachSpaceListret = RFAILED;
/*******************************************************************
 *
 * @brief Builds MIB
 *
