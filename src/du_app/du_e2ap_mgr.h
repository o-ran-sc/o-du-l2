...
{
   uint8_t modifyE2ConnectionCount;
   E2ConnectionItem modifyE2Node[MAX_TNL_ASSOCIATION];
   uint8_t failedToModifyE2ConnectionCount;
   E2ConnectionItem failedToModifyE2Node[MAX_TNL_ASSOCIATION];
}E2ConnectionList;
