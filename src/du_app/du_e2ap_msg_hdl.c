            ...
            case ProtocolIE_IDE2_id_RICaction_ToBeSetup_Item:
               {
                  ...
                  {
                     ricSubscriptionInfo->actionSequence[ricActionId].id = ricActionId;
                  ...
                  ricSubscriptionInfo->actionSequence[ricActionId].id = -1;
            ...
            case ProtocolIE_IDE2_id_RANfunctionID:
               {
                  ...
                  {
                     ricSubscriptionInfo->actionSequence[actionIdx].id = -1;
                  }
...
uint8_t fillMeasData(MeasurementData_t *measData, CmLListCp *measInfoListDb)
{
  ...
  for(measIdx = 0; measIdx < measInfoListDb->count; measIdx++)
  {
         ...
         case E2SM_KPM_IndicationHeader__indicationHeader_formats_PR_indicationHeader_Format1:
            {
               ...
               for(int idx = 0; idx <format1->colletStartTime.size; idx++)
                  format1->colletStartTime.buf[idx] = 1;
...
uint8_t fillRicIndication(RICindication_t *ricIndicationMsg, RicSubscription *ricSubscriptionInfo, ActionInfo *actionInfo)
{
   ...
   ricIndicationMsg->protocolIEs.list.array[idx]->value.choice.RICactionID = actionInfo->id;
