            ...
            case ProtocolIE_IDE2_id_RICaction_ToBeRemovedForModification_Item:
               {
                  ...
                  {
                     /* In case of any failure, action is rejected
                      * Removed to rejected-action-list in subscription response */
...
void procRicSubscriptionModificationRequest(E2AP_PDU_t *e2apMsg)
{
            ...
            case ProtocolIE_IDE2_id_RANfunctionID:
               {
                  ...
                  memset(&ranFuncDb->pendingSubsModRspInfo[ranFuncDb->numPendingSubsRsp], 0, sizeof(PendingSubsRspInfo));
                  memcpy(&ranFuncDb->pendingSubsModRspInfo[ranFuncDb->numPendingSubsRsp].requestId, 
                        &ricReqId, sizeof(RicRequestId));
                  ranFuncDb->pendingSubsModRspInfo[ranFuncDb->numPendingSubsRsp].ranFuncId = ranFuncId;
   ...
   else
   {
      ...
      {
         BuildAndSendStatsDeleteReq(ricSubsDb);
      }
