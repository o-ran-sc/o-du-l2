 ...
 *
 * ****************************************************************/
E2NodeComponent *searchE2NodeComponentInfo(uint8_t componentActionType)
{
   ...
   if(duCb.e2apDb.e2NodeComponentList.count)
   {
      ...
      while(node)
      {
         ...
         if((e2NodeComponentInfo->interfaceType == F1) && (e2NodeComponentInfo->componentActionType == componentActionType))
            break;
         else
            node = node->next;
      }
...
uint8_t BuildE2NodeConfigAddList(E2nodeComponentConfigAddition_List_t *e2NodeAddList)
{
   ...
   e2NodeComponentInfo = searchE2NodeComponentInfo(COMPONENT_ADD_LIST);
