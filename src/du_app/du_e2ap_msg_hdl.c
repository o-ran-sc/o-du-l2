...
void RicSubsModRequired(E2AP_PDU_t *e2apMsg)
{
...
uint8_t FillRicSubsModRequired(RICsubscriptionModificationRequired_t *ricSubsModReqd, RicSubscription *ricSubscription)
{
   ...
   if(numActionsMod)
   {
      ...
      {
         DU_LOG("\nERROR  -->  E2AP : Failed to fill actions required to be modified list");
         return RFAILED;
      }
   }
   ...
   if(numActionsRmv)
   {
      ...
      {
         DU_LOG("\nERROR  -->  E2AP : Failed to fill actions required to be removed list");
         return RFAILED;
      }
   }
...
uint8_t BuildAndSendRicSubsModRequired(RicSubscription *ricSubscription)
{
   ...
   while(true)
   {
      ...
      {
         DU_LOG("\nERROR  -->  E2AP : Failed to fill RIC Subscription Modification Required IEs");
         break;
      }
