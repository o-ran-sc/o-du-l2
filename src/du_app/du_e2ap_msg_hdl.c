...
*
*    Functionality: Build Ric subs action to be removed list
*
* @params[in]
*    RICactions_RemovedForModification_List_t to be filled
*    Num Of Action To Be removed
*    Action removed list
*
* @return ROK     - success
*         RFAILED - failure
...
*
*    Functionality: Build Ric subs action to be added list
*
* @params[in]
...
/*******************************************************************
*
* @brief Build Ric subscription action to be modified list
*
* @details
*
*    Function : BuildActionModifiedList
*
*    Functionality: Build Ric subs action to be modified list
*
* @params[in]
*    RICactions_ModifiedForModification_List_t to be filled
*    Num Of Action To Be modified
 ...
 *    Num Of Action To Be failed to be removed
...
uint8_t BuildActionFailedToBeRemovedList(RICactions_FailedToBeRemovedForModification_List_t *failedToBeRemovedActionList, uint8_t numOfActionFailedToBeRemoved, RejectedAction *actionFailedToBeRemoved)
{
   uint8_t arrIdx=0;
 ...
 *    Num Of Action To Be failed to be modified
...
uint8_t BuildActionFailedToBeModifiedList(RICactions_FailedToBeModifiedForModification_List_t *failedToBeModifiedActionList, uint8_t numOfActionFailedToBeModified, RejectedAction *actionFailedToBeModified)
{
   uint8_t arrIdx=0;
 ...
 *    Num Of Action To Be failed to be added
 ...
 *
 ******************************************************************/
uint8_t BuildAndSendRicSubscriptionModificationResponse(uint16_t ranFuncId,  RicRequestId requestId, RicSubsModificationReq tempModifyReq)
{
   uint8_t elementCnt = 0, ieIdx = 0, ret = RFAILED;
   E2AP_PDU_t         *e2apMsg = NULLP;
   RICsubscriptionModificationResponse_t *ricSubsModResponse = NULLP;
   ...
   while(true)
   {
      ...
      elementCnt = 2;
      if(tempModifyReq.numActionRemoved)
         elementCnt++;
      if(tempModifyReq.numActionModified)
         elementCnt++;
      if(tempModifyReq.numActionAdded)
         elementCnt++;
      if(tempModifyReq.numActionFailedToBeRemoved)
         elementCnt++;
      if(tempModifyReq.numActionFailedToBeModified)
         elementCnt++;
      if(tempModifyReq.numActionFailedToBeAdded)
         elementCnt++;
      ...
      ricSubsModResponseIe->value.choice.RICrequestID.ricRequestorID= requestId.requestorId;
      ricSubsModResponseIe->value.choice.RICrequestID.ricInstanceID = requestId.instanceId;
      ...
      ricSubsModResponseIe->value.choice.RANfunctionID = ranFuncId;
      ...
      if(tempModifyReq.numActionRemoved)
      {
         ...
         tempModifyReq.numActionRemoved, tempModifyReq.actionRemovedList) != ROK)
         {
      ...
      if(tempModifyReq.numActionFailedToBeRemoved)
      {
         ...
         tempModifyReq.numActionFailedToBeRemoved, tempModifyReq.actionFailedToBeRemovedList) != ROK)
         {
            DU_LOG("\nERROR  -->  E2AP : failed at [%s] : line [%d]", __func__, __LINE__);
            break;
         }
      ...
      if(tempModifyReq.numActionModified)
      {
         ...
         tempModifyReq.numActionModified, tempModifyReq.actionModifiedList) != ROK)
         {
            DU_LOG("\nERROR  -->  E2AP : failed at [%s] : line [%d]", __func__, __LINE__);
            break;
         }
      ...
      if(tempModifyReq.numActionFailedToBeModified)
      {
         ...
         tempModifyReq.numActionFailedToBeModified, tempModifyReq.actionFailedToBeModifiedList) != ROK)
         {
            DU_LOG("\nERROR  -->  E2AP : failed at [%s] : line [%d]", __func__, __LINE__);
            break;
         }
      ...
      if(tempModifyReq.numActionAdded)
      {
         ...
         tempModifyReq.numActionAdded, tempModifyReq.actionAddedList) != ROK)
         {
            DU_LOG("\nERROR  -->  E2AP : failed at [%s] : line [%d]", __func__, __LINE__);
            break;
         }
      ...
      if(tempModifyReq.numActionFailedToBeAdded)
      {
         ...
         tempModifyReq.numActionFailedToBeAdded, tempModifyReq.actionFailedToBeAddedList) != ROK)
         {
            DU_LOG("\nERROR  -->  E2AP : failed at [%s] : line [%d]", __func__, __LINE__);
            break;
         }
