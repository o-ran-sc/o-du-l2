...
uint8_t BuildE2NodeConfigAddList(E2nodeComponentConfigAddition_List_t *e2NodeAddList)
{
   ...
   e2NodeAddItem->e2nodeComponentConfiguration.e2nodeComponentRequestPart.size = f1SetupReqAndRspMsg.f1MsgReqEncodingSize;
   ...
   f1SetupReqAndRspMsg.f1MsgReqEncoding, e2NodeAddItem->e2nodeComponentConfiguration.\
   e2nodeComponentRequestPart.size);
   DU_FREE(f1SetupReqAndRspMsg.f1MsgReqEncoding,f1SetupReqAndRspMsg.f1MsgReqEncodingSize);
  
   /* E2 Node Component Response Part */
   e2NodeAddItem->e2nodeComponentConfiguration.e2nodeComponentResponsePart.size = f1SetupReqAndRspMsg.f1MsgRspEncodingSize; 
   ...
   f1SetupReqAndRspMsg.f1MsgRspEncoding, e2NodeAddItem->e2nodeComponentConfiguration.\
   e2nodeComponentResponsePart.size);
   DU_FREE(f1SetupReqAndRspMsg.f1MsgRspEncoding, f1SetupReqAndRspMsg.f1MsgRspEncodingSize);
