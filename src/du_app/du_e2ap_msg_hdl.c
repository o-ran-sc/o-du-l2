...
uint8_t BuildAndSendRemovalFailure(uint8_t transId, E2FailureCause failureCause)
{
   ...
   do
   {
      ...
      if(e2apMsg == NULLP)
      {
         DU_LOG("\nERROR  -->  E2AP : BuildAndSendRemovalFailure(): Memory allocation for E2AP-PDU failed");
         break;
      }
      ...
      if(e2apMsg->choice.unsuccessfulOutcome == NULLP)
      {
         DU_LOG("\nERROR  -->  E2AP : BuildAndSendRemovalFailure: Memory allocation failed for unsuccessfulOutcome");
         break;
      }
      ...
      if(!e2RemovalFailure->protocolIEs.list.array)
      {
         DU_LOG("\nERROR  -->  E2AP : BuildAndSendRemovalFailure: Memory allocation failed for protocol IE array");
         break;
      }
      ...
      for(ieIdx=0; ieIdx < elementCnt; ieIdx++)
      {
         ...
         if(!e2RemovalFailure->protocolIEs.list.array[ieIdx])
         {
            DU_LOG("\nERROR  -->  E2AP : BuildAndSendRemovalFailure: Memory allocation failed for protocol IE array element");
            break;
         }
      }
      if(ieIdx < elementCnt)
...
uint8_t BuildAndSendRemovalResponse(uint8_t transId)
{
   ...
   do
   {
      ...
      if(e2apMsg == NULLP)
      {
         DU_LOG("\nERROR  -->  E2AP : BuildAndSendRemovalResponse(): Memory allocation for E2AP-PDU failed");
         break;
      }
      ...
      if(e2apMsg->choice.successfulOutcome == NULLP)
      {
         DU_LOG("\nERROR  -->  E2AP : BuildAndSendRemovalResponse: Memory allocation failed for successfulOutcome");
         break;
      }
      ...
      if(!e2RemovalResponse->protocolIEs.list.array)
      {
         DU_LOG("\nERROR  -->  E2AP : BuildAndSendRemovalResponse: Memory allocation failed for protocol IE array");
         break;
      }
      ...
      for(ieIdx=0; ieIdx < elementCnt; ieIdx++)
      {
         ...
         if(!e2RemovalResponse->protocolIEs.list.array[ieIdx])
         {
            DU_LOG("\nERROR  -->  E2AP : BuildAndSendRemovalResponse: Memory allocation failed for protocol IE array element");
            break;
         }
      }
      if(ieIdx < elementCnt)
