      ...
      case  ProtocolIE_IDE2_id_E2nodeComponentConfigRemovalAck:
         {
            ...
            DU_FREE(e2NodeComponentInfo->deleteConfiguration->componentRequestPart, e2NodeComponentInfo->deleteConfiguration->reqBufSize);
            DU_FREE(e2NodeComponentInfo->deleteConfiguration->componentResponsePart, e2NodeComponentInfo->deleteConfiguration->rspBufSize);
         ...
         case ProtocolIE_IDE2_id_E2nodeComponentConfigAdditionAck:
            {
               ...
               for(idx =0; idx <e2NodeCfgAckList->list.count; idx++)
               {
                  ...
                  handleE2NodeConfigUpdateAckIes((PTR)&e2NodeAddAckItem->value.choice.E2nodeComponentConfigAdditionAck_Item, ProtocolIE_IDE2_id_E2nodeComponentConfigAdditionAck);
               }
               break;
            }
               ...
               case ProtocolIE_IDE2_id_E2nodeComponentConfigAdditionAck:
               {
                  ...
                  if(e2NodeConfigAdditionAckList->list.array)
                  {
                     for(e2CfgIdx = 0; e2CfgIdx< e2NodeConfigAdditionAckList->list.count; e2CfgIdx++) 
                     {
                        ...
                        handleE2NodeConfigUpdateAckIes((PTR)&e2NodeAdditionAckItem->value.choice.E2nodeComponentConfigAdditionAck_Item, ProtocolIE_IDE2_id_E2nodeComponentConfigAdditionAck);
                     }
                  }
                  break;
               }
               case ProtocolIE_IDE2_id_E2nodeComponentConfigUpdateAck:
               {
                  ...
                  if(e2NodeConfigUpdateAckList->list.array)
                  {
                     for(e2CfgIdx = 0; e2CfgIdx< e2NodeConfigUpdateAckList->list.count; e2CfgIdx++) 
                     {
                        ...
                        handleE2NodeConfigUpdateAckIes((PTR)&e2NodeUpdateAckItem->value.choice.E2nodeComponentConfigUpdateAck_Item, ProtocolIE_IDE2_id_E2nodeComponentConfigUpdateAck);
                     }
                  }
                  break;
               }
               case ProtocolIE_IDE2_id_E2nodeComponentConfigRemovalAck:
               {
                  ...
                  if(e2NodeConfigRemovalAckList->list.array)
                  {
                     for(e2CfgIdx = 0; e2CfgIdx< e2NodeConfigRemovalAckList->list.count; e2CfgIdx++) 
                     {
                        ...
                        handleE2NodeConfigUpdateAckIes((PTR)&e2NodeRemovalAckItem->value.choice.E2nodeComponentConfigRemovalAck_Item, ProtocolIE_IDE2_id_E2nodeComponentConfigRemovalAck);
                     }
                  }
                  break;
               }
