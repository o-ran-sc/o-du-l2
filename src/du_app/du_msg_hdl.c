 ...
 *
 * ****************************************************************/
uint8_t BuildAndSendSliceConfigInfo(RrmPolicy *rrmPolicy[], uint8_t totalRrmPolicy, uint8_t totalSliceCfg)
{
   Pst pst;
   ...
   {
      if(fillSliceCfgReCfgInfo(sliceCfgReq, rrmPolicy, totalRrmPolicy, totalSliceCfg) != ROK)
      {   
 ...
 *
 * ****************************************************************/
uint8_t BuildAndSendSliceReCfgInfo(RrmPolicy *rrmPolicy[], uint8_t totalRrmPolicy, uint8_t totalSliceReCfg)
{
   Pst pst;
   ...
   {
      if(fillSliceCfgReCfgInfo(sliceReCfgReq, rrmPolicy, totalRrmPolicy, totalSliceReCfg) != ROK)
      {
