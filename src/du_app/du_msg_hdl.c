...
uint8_t duSendEgtpTestData()
{
   ...
   ipv4Hdr.hdrVer = 0x45;
   ipv4Hdr.proto = 1;
   ipv4Hdr.srcAddr = CM_INET_NTOH_uint32_t(duCfgParam.egtpParams.localIp.ipV4Addr);
   ipv4Hdr.destAddr = CM_INET_NTOH_uint32_t(duCfgParam.egtpParams.destIp.ipV4Addr);
