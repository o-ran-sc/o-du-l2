...
uint8_t commonInit()
{
   ...
   {
      DU_LOG("\nDU_APP : DU APP System Task creation for DU APP failed");
      return RFAILED;
   }
   ...
   {
      DU_LOG("\nDU_APP : DU APP System Task creation for RLC DL/MAC failed");
      return RFAILED;
   }
   ...
   {
      DU_LOG("\nDU_APP : DU APP System Task creation for RLC UL failed");
      return RFAILED;
   }
   ...
   {
      DU_LOG("\nDU_APP : DU APP System Task creation for SCTP failed");
      return RFAILED;
   }
