...
uint8_t commonInit()
{
   ...
   ODU_SET_THREAD_AFFINITY(&du_app_stsk, SS_AFFINITY_MODE_SPECIFIC, 29, 0);
   ...
   ODU_SET_THREAD_AFFINITY(&rlc_mac_cl_stsk, SS_AFFINITY_MODE_SPECIFIC, 29, 0);
   ...
   ODU_SET_THREAD_AFFINITY(&rlc_ul_stsk, SS_AFFINITY_MODE_SPECIFIC, 29, 0);
   ...
   ODU_SET_THREAD_AFFINITY(&sctp_stsk, SS_AFFINITY_MODE_EXCL, 26, 0);
   ...
   ODU_SET_THREAD_AFFINITY(&lwr_mac_stsk, SS_AFFINITY_MODE_EXCL, 28, 0);
