...
uint8_t commonInit()
{
   ...
   ODU_SET_THREAD_AFFINITY(&du_app_stsk, SS_AFFINITY_MODE_SPECIFIC, 18, 0);
   ...
   ODU_SET_THREAD_AFFINITY(&rlc_mac_cl_stsk, SS_AFFINITY_MODE_SPECIFIC, 18, 0);
   ...
   ODU_SET_THREAD_AFFINITY(&rlc_ul_stsk, SS_AFFINITY_MODE_SPECIFIC, 18, 0);
   ...
   ODU_SET_THREAD_AFFINITY(&sctp_stsk, SS_AFFINITY_MODE_EXCL, 17, 0);
   ...
   ODU_SET_THREAD_AFFINITY(&lwr_mac_stsk, SS_AFFINITY_MODE_EXCL, 15, 0);
   ...
   ODU_SET_THREAD_AFFINITY(&fapi_cl_recvr_stsk, SS_AFFINITY_MODE_EXCL, 36, 0);
   ...
   ODU_SET_THREAD_AFFINITY(&fapi_cl_slot_ind_stsk, SS_AFFINITY_MODE_EXCL, 37, 0);
#endif
