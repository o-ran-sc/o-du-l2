...
static asn_oer_constraints_t asn_OER_type_DRB_Notify_List_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..64)) */};
...
static asn_TYPE_member_t asn_MBR_DRB_Notify_List_1[] = {
	{ ATF_POINTER, 0, 0,
		...
		0,
		&asn_DEF_ProtocolIE_SingleContainer_4590P56,
		0,
		{ 0, 0, 0 },
...
asn_TYPE_descriptor_t asn_DEF_DRB_Notify_List = {
	...
	sizeof(asn_DEF_DRB_Notify_List_tags_1)
		/sizeof(asn_DEF_DRB_Notify_List_tags_1[0]), /* 1 */
	{ &asn_OER_type_DRB_Notify_List_constr_1, &asn_PER_type_DRB_Notify_List_constr_1, SEQUENCE_OF_constraint },
