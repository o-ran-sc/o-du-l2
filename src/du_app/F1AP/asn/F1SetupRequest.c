...
asn_TYPE_member_t asn_MBR_F1SetupRequest_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct F1SetupRequest, protocolIEs),
...
asn_SEQUENCE_specifics_t asn_SPC_F1SetupRequest_specs_1 = {
