...
S16 SRegInfoShow  ARGS((Region region, U32 *availmem));
S16 SGetRegInfo ARGS((Region region, SsMemDbgInfo *dbgInfo));
#ifdef XEON_SPECIFIC_CHANGES
S16 SRegReachedMemThreshold ARGS((Region region, U8 maxBkt));
#endif
#ifdef SSI_DEBUG_LEVEL1
S16 SPrintRegMemStatusInfo ARGS((Region region, U8 typeFlag));
