...
extern asn_SEQUENCE_specifics_t asn_SPC_RICaction_RefusedToBeModified_Item_specs_1;
extern asn_TYPE_member_t asn_MBR_RICaction_RefusedToBeModified_Item_1[2];
