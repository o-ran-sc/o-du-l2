...
#include "RICsubscription-List-withCauseE2.h"
...
typedef enum RICsubscription_withCauseE2_ItemIEs__value_PR {
	RICsubscription_withCauseE2_ItemIEs__value_PR_NOTHING,	/* No components present */
	RICsubscription_withCauseE2_ItemIEs__value_PR_RICsubscription_withCauseE2_Item
} RICsubscription_withCauseE2_ItemIEs__value_PR;
...
typedef enum RICsubscriptionDeleteRequired_IEs__value_PR {
	...
	RICsubscriptionDeleteRequired_IEs__value_PR_RICsubscription_List_withCauseE2
...
typedef struct RICsubscription_withCauseE2_ItemIEs {
	ProtocolIE_IDE2_t	 id;
	CriticalityE2_t	 criticality;
	struct RICsubscription_withCauseE2_ItemIEs__value {
		RICsubscription_withCauseE2_ItemIEs__value_PR present;
		union RICsubscription_withCauseE2_ItemIEs__value_u {
			RICsubscription_withCauseE2_Item_t	 RICsubscription_withCauseE2_Item;
		} choice;
	...
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} RICsubscription_withCauseE2_ItemIEs_t;
...
typedef struct RICsubscriptionDeleteRequired_IEs {
	...
	struct RICsubscriptionDeleteRequired_IEs__value {
		...
		union RICsubscriptionDeleteRequired_IEs__value_u {
			RICsubscription_List_withCauseE2_t	 RICsubscription_List_withCauseE2;
		} choice;
...
extern asn_TYPE_descriptor_t asn_DEF_RICsubscription_withCauseE2_ItemIEs;
extern asn_SEQUENCE_specifics_t asn_SPC_RICsubscription_withCauseE2_ItemIEs_specs_13;
extern asn_TYPE_member_t asn_MBR_RICsubscription_withCauseE2_ItemIEs_13[3];
