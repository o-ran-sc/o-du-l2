...
static asn_TYPE_member_t asn_MBR_RICaction_RequiredToBeModified_Item_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_RICaction_RequiredToBeModified_Item_specs_1 = {
