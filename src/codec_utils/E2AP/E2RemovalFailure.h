...
typedef struct E2RemovalFailure {
	ProtocolIE_ContainerE2_2530P38_t	 protocolIEs;
	/*
...
extern asn_SEQUENCE_specifics_t asn_SPC_E2RemovalFailure_specs_1;
extern asn_TYPE_member_t asn_MBR_E2RemovalFailure_1[1];
