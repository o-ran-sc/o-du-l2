...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_slotSpecificConfigurationsToAddModList_constr_2,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_slotSpecificConfigurationsToreleaseList_constr_4,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
		0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
...
asn_TYPE_member_t asn_MBR_TDD_UL_DL_ConfigDedicated_1[] = {
...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
			&asn_PER_memb_slotSpecificConfigurationsToAddModList_constr_2,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
#if !defined(ASN_DISABLE_JER_SUPPORT)
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_slotSpecificConfigurationsToAddModList_constraint_1
		},
		0, 0, /* No default value */
		"slotSpecificConfigurationsToAddModList"
		},
	{ ATF_POINTER, 1, offsetof(struct TDD_UL_DL_ConfigDedicated, slotSpecificConfigurationsToreleaseList),
		...
		0,
		{
			...
			0,
#endif  /* !defined(ASN_DISABLE_JER_SUPPORT) */
			memb_slotSpecificConfigurationsToreleaseList_constraint_1
		},
		0, 0, /* No default value */
		"slotSpecificConfigurationsToreleaseList"
		},
