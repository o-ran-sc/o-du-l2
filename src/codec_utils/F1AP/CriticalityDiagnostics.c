...
static asn_TYPE_member_t asn_MBR_CriticalityDiagnostics_1[] = {
	{ ATF_POINTER, 6, offsetof(struct CriticalityDiagnostics, procedureCode),
	...
	{ ATF_POINTER, 5, offsetof(struct CriticalityDiagnostics, triggeringMessage),
	...
	{ ATF_POINTER, 4, offsetof(struct CriticalityDiagnostics, procedureCriticality),
	...
	{ ATF_POINTER, 3, offsetof(struct CriticalityDiagnostics, transactionID),
	...
	{ ATF_POINTER, 1, offsetof(struct CriticalityDiagnostics, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_4624P14,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_CriticalityDiagnostics_oms_1[] = { 0, 1, 2, 3, 4, 5 };
