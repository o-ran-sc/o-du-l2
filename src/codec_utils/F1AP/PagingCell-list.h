...
extern asn_SET_OF_specifics_t asn_SPC_PagingCell_list_specs_1;
extern asn_TYPE_member_t asn_MBR_PagingCell_list_1[1];
extern asn_per_constraints_t asn_PER_type_PagingCell_list_constr_1;
