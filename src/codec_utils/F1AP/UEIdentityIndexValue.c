...
static asn_oer_constraints_t asn_OER_memb_indexLength10_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	10	/* (SIZE(10..10)) */};
static asn_per_constraints_t asn_PER_memb_indexLength10_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  10,  10 }	/* (SIZE(10..10)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_UEIdentityIndexValue_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_UEIdentityIndexValue_constr_1 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_UEIdentityIndexValue_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UEIdentityIndexValue, choice.indexLength10),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_indexLength10_constr_2, &asn_PER_memb_indexLength10_constr_2,  memb_indexLength10_constraint_1 },
...
static const asn_TYPE_tag2member_t asn_MAP_UEIdentityIndexValue_tag2el_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_UEIdentityIndexValue = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_UEIdentityIndexValue_constr_1, &asn_PER_type_UEIdentityIndexValue_constr_1, CHOICE_constraint },
	asn_MBR_UEIdentityIndexValue_1,
	2,	/* Elements count */
	&asn_SPC_UEIdentityIndexValue_specs_1	/* Additional specs */
};
