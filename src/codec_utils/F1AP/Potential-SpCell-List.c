...
static asn_oer_constraints_t asn_OER_type_Potential_SpCell_List_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..64)) */};
static asn_per_constraints_t asn_PER_type_Potential_SpCell_List_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 7,  7,  0,  64 }	/* (SIZE(0..64)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_Potential_SpCell_List_1[] = {
	{ ATF_POINTER, 0, 0,
...
static asn_SET_OF_specifics_t asn_SPC_Potential_SpCell_List_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_Potential_SpCell_List = {
	...
	sizeof(asn_DEF_Potential_SpCell_List_tags_1)
		/sizeof(asn_DEF_Potential_SpCell_List_tags_1[0]), /* 1 */
	{ &asn_OER_type_Potential_SpCell_List_constr_1, &asn_PER_type_Potential_SpCell_List_constr_1, SEQUENCE_OF_constraint },
