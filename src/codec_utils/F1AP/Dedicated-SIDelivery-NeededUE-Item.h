...
extern asn_SEQUENCE_specifics_t asn_SPC_Dedicated_SIDelivery_NeededUE_Item_specs_1;
extern asn_TYPE_member_t asn_MBR_Dedicated_SIDelivery_NeededUE_Item_1[3];
