...
extern asn_SEQUENCE_specifics_t asn_SPC_GNB_CU_TNL_Association_Setup_Item_specs_1;
extern asn_TYPE_member_t asn_MBR_GNB_CU_TNL_Association_Setup_Item_1[2];
