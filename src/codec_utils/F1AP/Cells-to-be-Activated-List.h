...
extern asn_SET_OF_specifics_t asn_SPC_Cells_to_be_Activated_List_specs_1;
extern asn_TYPE_member_t asn_MBR_Cells_to_be_Activated_List_1[1];
extern asn_per_constraints_t asn_PER_type_Cells_to_be_Activated_List_constr_1;
