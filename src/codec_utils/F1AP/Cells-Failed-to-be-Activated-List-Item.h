...
extern asn_SEQUENCE_specifics_t asn_SPC_Cells_Failed_to_be_Activated_List_Item_specs_1;
extern asn_TYPE_member_t asn_MBR_Cells_Failed_to_be_Activated_List_Item_1[3];
