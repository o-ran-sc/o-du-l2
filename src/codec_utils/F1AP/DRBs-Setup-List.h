...
extern asn_SET_OF_specifics_t asn_SPC_DRBs_Setup_List_specs_1;
extern asn_TYPE_member_t asn_MBR_DRBs_Setup_List_1[1];
extern asn_per_constraints_t asn_PER_type_DRBs_Setup_List_constr_1;
