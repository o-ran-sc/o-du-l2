...
#ifndef	_DRBs_ToBeSetupMod_Item_H_
#define	_DRBs_ToBeSetupMod_Item_H_
...
typedef struct DRBs_ToBeSetupMod_Item {
	DRBID_t	 dRBID;
...
} DRBs_ToBeSetupMod_Item_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_DRBs_ToBeSetupMod_Item;
extern asn_SEQUENCE_specifics_t asn_SPC_DRBs_ToBeSetupMod_Item_specs_1;
extern asn_TYPE_member_t asn_MBR_DRBs_ToBeSetupMod_Item_1[7];

#ifdef __cplusplus
}
#endif

#endif	/* _DRBs_ToBeSetupMod_Item_H_ */
