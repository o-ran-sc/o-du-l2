...
#ifndef	_SCell_ToBeSetup_Item_H_
#define	_SCell_ToBeSetup_Item_H_
...
typedef struct SCell_ToBeSetup_Item {
	NRCGI_t	 sCell_ID;
...
} SCell_ToBeSetup_Item_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_SCell_ToBeSetup_Item;
extern asn_SEQUENCE_specifics_t asn_SPC_SCell_ToBeSetup_Item_specs_1;
extern asn_TYPE_member_t asn_MBR_SCell_ToBeSetup_Item_1[4];

#ifdef __cplusplus
}
#endif

#endif	/* _SCell_ToBeSetup_Item_H_ */
