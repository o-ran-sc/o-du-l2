...
#ifndef	_SRBs_Required_ToBeReleased_Item_H_
...
typedef struct SRBs_Required_ToBeReleased_Item {
	SRBID_t	 sRBID;
...
} SRBs_Required_ToBeReleased_Item_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_SRBs_Required_ToBeReleased_Item;
extern asn_SEQUENCE_specifics_t asn_SPC_SRBs_Required_ToBeReleased_Item_specs_1;
extern asn_TYPE_member_t asn_MBR_SRBs_Required_ToBeReleased_Item_1[2];

#ifdef __cplusplus
}
#endif

#endif	/* _SRBs_Required_ToBeReleased_Item_H_ */
