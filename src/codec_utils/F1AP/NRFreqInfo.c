...
static asn_oer_constraints_t asn_OER_type_freqBandListNr_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..32)) */};
static asn_per_constraints_t asn_PER_type_freqBandListNr_constr_4 CC_NOTUSED = {
...
static asn_oer_constraints_t asn_OER_memb_freqBandListNr_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..32)) */};
static asn_per_constraints_t asn_PER_memb_freqBandListNr_constr_4 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 5,  5,  1,  32 }	/* (SIZE(1..32)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_freqBandListNr_4[] = {
	{ ATF_POINTER, 0, 0,
...
static const ber_tlv_tag_t asn_DEF_freqBandListNr_tags_4[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_freqBandListNr_specs_4 = {
	sizeof(struct NRFreqInfo__freqBandListNr),
	offsetof(struct NRFreqInfo__freqBandListNr, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_freqBandListNr_4 = {
	"freqBandListNr",
	"freqBandListNr",
	&asn_OP_SEQUENCE_OF,
	asn_DEF_freqBandListNr_tags_4,
	sizeof(asn_DEF_freqBandListNr_tags_4)
		/sizeof(asn_DEF_freqBandListNr_tags_4[0]) - 1, /* 1 */
	asn_DEF_freqBandListNr_tags_4,	/* Same as above */
	sizeof(asn_DEF_freqBandListNr_tags_4)
		/sizeof(asn_DEF_freqBandListNr_tags_4[0]), /* 2 */
	{ &asn_OER_type_freqBandListNr_constr_4, &asn_PER_type_freqBandListNr_constr_4, SEQUENCE_OF_constraint },
	asn_MBR_freqBandListNr_4,
	1,	/* Single element */
	&asn_SPC_freqBandListNr_specs_4	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_NRFreqInfo_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct NRFreqInfo, sul_Information),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NRFreqInfo, freqBandListNr),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_freqBandListNr_4,
		0,
		{ &asn_OER_memb_freqBandListNr_constr_4, &asn_PER_memb_freqBandListNr_constr_4,  memb_freqBandListNr_constraint_1 },
		0, 0, /* No default value */
		"freqBandListNr"
		},
	{ ATF_POINTER, 1, offsetof(struct NRFreqInfo, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_4624P66,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_NRFreqInfo_oms_1[] = { 1, 3 };
