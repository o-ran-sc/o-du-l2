...
asn_per_constraints_t asn_PER_type_InactivityMonitoringRequest_constr_1 CC_NOTUSED = {
...
const asn_INTEGER_specifics_t asn_SPC_InactivityMonitoringRequest_specs_1 = {
...
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_InactivityMonitoringRequest_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
