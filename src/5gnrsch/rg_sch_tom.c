...
{ 
  ...
  memset((U8 *)pucchReqInfo->hqInfo.hqRes,0xff,sizeof(U16)*TFU_MAX_HQ_RES);
#ifdef LTEMAC_SPS
...
#ifdef TFU_ALLOC_EVENT_NO_INIT
     memset((U8 *)&pucchRecpInfo->t.pucchRecpReq, 0, sizeof(TfuUePucchRecpReq));
      pucchRecpInfo->type = TFU_RECP_REQ_PUCCH;
#endif      
      /*Fill SR params*/
...
#endif
{
   ...
   if(pucchInfo == NULLP)
   {
      ...
      memset((U8 *)pucchInfo->pucchRecpInfo->t.pucchRecpReq.hqInfo.hqRes,0xff,sizeof(U16)*TFU_MAX_HQ_RES);
#ifdef TFU_ALLOC_EVENT_NO_INIT
      memset((U8 *)&pucchInfo->pucchRecpInfo->t.pucchRecpReq, 0, sizeof(TfuUePucchRecpReq));
#endif
