...
typedef struct schPrbAlloc
{
   ...
   uint64_t  prbBitMap[SCH_SYMBOL_PER_SLOT][PRB_BITMAP_LEN];  /*!< BitMap to store the allocated PRBs */
}SchPrbAlloc;
...
uint8_t schFillRar(SchCellCb *cell, uint16_t ueIdx, RarAlloc *rarAlloc, uint8_t k0Index, SlotTimingInfo rarTime);
