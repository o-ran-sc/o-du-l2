...
#define MAX_LCID 11 /* 3 SRBs and 8 DRBs */

#define CRC_FAILED 0
#define CRC_PASSED 1

#define RLC_HDR_SIZE 2   /* 2 bytes of RLC Header size */
#define MAC_PDU_SHORT_HDR_SIZE  2  /* 2bytes of MAC Header */
#define MAC_PDU_LONG_HDR_SIZE   3  /* 3bytes of MAC Header */
