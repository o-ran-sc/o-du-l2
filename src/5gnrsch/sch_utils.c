...
* @details
*
*     Function: schCalcTransportBlockSize
*
*     This function calculates the transport block size
*
*  @param[in]  numPrb in bytes
*  @param[in]  mcs
*  @param[in]  number of symbols
*  @return   tbSize
**/
uint16_t schCalcTransportBlockSize(uint16_t numPrb, uint16_t mcs, uint8_t numSymbols)
{   
   uint16_t tbSize = 0;
   uint16_t tbsIndex = 0;
   uint16_t nre = 0;
