...
void schInitUlSlot(SchUlSlotInfo *schUlSlotInfo)
{
   ...
   memset(schUlSlotInfo->resAllocBitMap, 0, SCH_SYMBOL_PER_SLOT*RES_ALLOC_IDX_LEN*MAX_RES_ALLOC_IDX/8);
...
void schInitDlSlot(SchDlSlotInfo *schDlSlotInfo)
{
   ...
   memset(schDlSlotInfo->resAllocBitMap, 0, SCH_SYMBOL_PER_SLOT*RES_ALLOC_IDX_LEN*MAX_RES_ALLOC_IDX/8);
