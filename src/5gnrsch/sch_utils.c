...
// for PDSCH Time Domain Allocation from TS 38.214 subclause 5.1.2.1.1
...
uint8_t getTdaInfo(PdschTimeAlloc *pdschTimeAlloc,uint8_t tableType, uint8_t dmrsTypeAPos, uint8_t cyclicPrefix)
{
   ...
   switch(tableType)
   {
	 ...
	 if(cyclicPrefix == 0)/*Normal-CP*/
	 {
	    if(dmrsTypeAPos == 2)
	    {
	       pdschTimeAlloc->startSymb = table_5_1_2_1_1_2_time_dom_res_alloc_A_dmrs_typeA_pos2[rowIndex][2]; 
	       pdschTimeAlloc->numSymb = table_5_1_2_1_1_2_time_dom_res_alloc_A_dmrs_typeA_pos2[rowIndex][3];
	    }
	    else if(dmrsTypeAPos == 3)
	    {
	       pdschTimeAlloc->startSymb = table_5_1_2_1_1_2_time_dom_res_alloc_A_dmrs_typeA_pos3[rowIndex][2]; 
	       pdschTimeAlloc->numSymb = table_5_1_2_1_1_2_time_dom_res_alloc_A_dmrs_typeA_pos3[rowIndex][3];
	 ...
	 else if(cyclicPrefix == 1) /*extended-CP*/
	 {
	    if(dmrsTypeAPos == 2)
	    {
	       pdschTimeAlloc->startSymb = table_5_1_2_1_1_3_time_dom_res_alloc_A_extCP_dmrs_typeA_pos2[rowIndex][2]; 
	       pdschTimeAlloc->numSymb = table_5_1_2_1_1_3_time_dom_res_alloc_A_extCP_dmrs_typeA_pos2[rowIndex][3];
	    }
	    else if(dmrsTypeAPos == 3)
	    {
	       pdschTimeAlloc->startSymb = table_5_1_2_1_1_3_time_dom_res_alloc_A_extCP_dmrs_typeA_pos3[rowIndex][2]; 
	       pdschTimeAlloc->numSymb = table_5_1_2_1_1_3_time_dom_res_alloc_A_extCP_dmrs_typeA_pos3[rowIndex][3];
	    }
	    else
	    {
	       DU_LOG("\nERROR  --> SCH_UTILS: getTdaInfo: Incorrect dmrsTypeAPos:%d",dmrsTypeAPos);
	 ...
	 else
	 {
      ...
      case 1:/*Default-B*/
      {
	    if(dmrsTypeAPos == 2)
	    {
	       pdschTimeAlloc->startSymb = table_5_1_2_1_1_4_time_dom_res_alloc_B_dmrs_typeA_pos2[rowIndex][2]; 
	       pdschTimeAlloc->numSymb = table_5_1_2_1_1_4_time_dom_res_alloc_B_dmrs_typeA_pos2[rowIndex][3];
	    }
	    else if(dmrsTypeAPos == 3)
	    {
	       pdschTimeAlloc->startSymb = table_5_1_2_1_1_4_time_dom_res_alloc_B_dmrs_typeA_pos3[rowIndex][2]; 
	       pdschTimeAlloc->numSymb = table_5_1_2_1_1_4_time_dom_res_alloc_B_dmrs_typeA_pos3[rowIndex][3];
      ...
      case 2:/*Default-C*/
      {
	    if(dmrsTypeAPos == 2)
	    {
	       pdschTimeAlloc->startSymb = table_5_1_2_1_1_5_time_dom_res_alloc_C_dmrs_typeA_pos2[rowIndex][2]; 
	       pdschTimeAlloc->numSymb = table_5_1_2_1_1_5_time_dom_res_alloc_C_dmrs_typeA_pos2[rowIndex][3];
	    }
	    else if(dmrsTypeAPos == 3)
	    {
	       pdschTimeAlloc->startSymb = table_5_1_2_1_1_5_time_dom_res_alloc_C_dmrs_typeA_pos3[rowIndex][2]; 
	       pdschTimeAlloc->numSymb = table_5_1_2_1_1_5_time_dom_res_alloc_C_dmrs_typeA_pos3[rowIndex][3];
