...
uint8_t *msg3NumRb)
{
   ...
   newTbSize = schCalcTransportBlockSize(numRb, mcs, numPdschSymbols);
   ...
   schUlSlotInfo->schPuschInfo->tbInfo.tbSize     = newTbSize; /*Considering 2 PRBs */
