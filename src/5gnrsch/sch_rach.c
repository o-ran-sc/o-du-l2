...
#endif
   {
      ...
      if(windowStatus == WITHIN_WINDOW)
      {
         ...
         for(k0TblIdx = 0; k0TblIdx < k0K1InfoTbl->k0k1TimingInfo[dciSlot].numK0; k0TblIdx++)
         {
            ...
            k2Found = schGetMsg3K2(cell,NULLP, dciTime.slot,  &msg3Time, FALSE);
#if 0
      ...
      msg3PuschInfo = schAllocMsg3Pusch(cell->instIdx, cell->raReq[ueId-1]->rachInd->crnti, k2Index, msg3Time, FALSE);
      if(msg3PuschInfo)
      {
         /* Fill RAR info */
