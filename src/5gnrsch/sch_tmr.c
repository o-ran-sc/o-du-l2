...
uint8_t SchProcDlTotalPrbUsageTmrExp(TotalPrbUsage *dlTotalPrbUsage)
{
   ...
   SchBuildAndSendStatsInd(DL_TOTAL_PRB_USAGE, (void *)&percentageOfTotalPrbUsed);
 ...
 *      -# RFAILED
*/
uint8_t SchProcDlTotalPrbUsageTmrExp(TotalPrbUsage *ulTotalPrbUsage)
{
   uint8_t percentageOfTotalPrbUsed;

   percentageOfTotalPrbUsed = ((ulTotalPrbUsage->numPrbUsedForTx * 100) / ulTotalPrbUsage->totalPrbAvailForTx);
   SchBuildAndSendStatsInd(UL_TOTAL_PRB_USAGE, (void *)&percentageOfTotalPrbUsed);
