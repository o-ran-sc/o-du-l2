 ...
 *
 *   [Step-1] If numStatsGroup = 0, delete all the RIC subscription related
 *   information from DB.
 *   [Step-2] Else if numStatsGroup > 0, delete only those RIC subscription
 *   action from DB whose information are present in stats delete request.
