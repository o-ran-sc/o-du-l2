...
SchPdschConfig pdschDedCfg, uint8_t ulAckListCount, uint8_t *UlAckTbl)
{
   ...
   /* Commented this for resolving warnings. Presently variable is not required
    * But this will require for harq processing */
   // uint8_t k0TmpVal = 0; 
   ...
   for(slotIdx = 0; slotIdx < cell->numSlots; slotIdx++)
   {
      ...
      {
         /* These if 0 we will remove during harq processing */
#if 0
         if(pdschCfgCmnPres == true)
         {
