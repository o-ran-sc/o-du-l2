...
uint16_t schAllocPucchResource(SchPucchInfo *schPucchInfo, Inst inst)
{
   ...
   schPucchInfo->fdAlloc.startPrb = ulBwp->firstPrb + pucchResourceSet[pucchIdx][3];
...
uint16_t schAllocatePucchForDlHarq(SchCellCb *cell,uint16_t crnti, uint16_t slot)
{
