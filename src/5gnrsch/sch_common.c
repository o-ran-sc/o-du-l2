                                ...
                                SchPdcchAllocInfo *pdcchAllocInfo)
{
   ...
   SchBwpDlCfg *initialDlBwp = NULLP;
   SchBwpUlCfg *initialUlBwp = NULLP;
   SchUeCb *ueCb = NULLP;
   ...
   else
   {
      ...
      DU_LOG("\nSANGEETA r_pucch:%d, startPrb:%d, n_cce:%d, N_cce:%d", r_pucch, startPrb, n_cce, N_cce);
      ...
      if (ret == ROK)
      {
         DU_LOG("\nSANGEETA SUCCESSFUL PUCCH alloc");
