...
uint8_t schFillUlDciForMsg3Retx(SchRaCb *raCb, SchPuschInfo *puschInfo, DciInfo *dciInfo)
{
   ...
   dciInfo->dciFormatInfo.format.format0_0.freqAlloc.startPrb  = msg3HqProc->puschStartPrb;
   dciInfo->dciFormatInfo.format.format0_0.freqAlloc.numPrb    = msg3HqProc->puschNumPrb;
   ...
   dciInfo->dciFormatInfo.format.format0_0.rv                  = msg3HqProc->tbInfo.rv;
   dciInfo->dciFormatInfo.format.format0_0.tpcCmd              = 0; //Sphoorthi TODO: check
   dciInfo->dciFormatInfo.format.format0_0.sUlCfgd             = FALSE; /* SUL not configured */
...
uint8_t schFillUlDci(SchUeCb *ueCb, SchPuschInfo *puschInfo, DciInfo *dciInfo, bool isRetx, SchUlHqProcCb *hqP)
{
   ...
   dciInfo->dciFormatInfo.format.format0_0.freqAlloc.startPrb  = puschInfo->fdAlloc.resAlloc.type1.startPrb;
   dciInfo->dciFormatInfo.format.format0_0.freqAlloc.numPrb    = puschInfo->fdAlloc.resAlloc.type1.numPrb;
   ...
   dciInfo->dciFormatInfo.format.format0_0.rv                  = puschInfo->tbInfo.rv;
   dciInfo->dciFormatInfo.format.format0_0.tpcCmd              = 0; //Sphoorthi TODO: check
   dciInfo->dciFormatInfo.format.format0_0.sUlCfgd             = FALSE; /* SUL not configured */
