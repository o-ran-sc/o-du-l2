...
{
#ifdef INTEL_FAPI
   DU_LOG("\nDEBUG  -->  PHY_STUB: Received Param Request in PHY");
...
uint16_t l1BuildAndSendRxDataInd(uint16_t slot, uint16_t sfn, fapi_ul_pusch_pdu_t puschPdu)
{
   ...
   switch(type)
   {
      case MSG_TYPE_MSG3: 
	 {
	    DU_LOG("\nINFO   -->  PHY_STUB: Forming MSG3 PDU ");
      ...
      {
	 DU_LOG("\nINFO   -->  PHY_STUB: Forming SHORT BSR PDU ");
	 uint8_t lcgId = 0;
	 ...
	 break;
      ...
      case MSG_TYPE_MSG5:
      {
	 DU_LOG("\nINFO   -->  PHY_STUB: Forming MSG5 PDU");
	 ...
	 break;
      ...
      {
	 DU_LOG("\nINFO   -->  PHY_STUB: Forming SECURITY MODE COMPLETE PDU");
	 uint8_t  pduLen = 12;
	 ...
	 break;
	  ...
	  DU_LOG("\nINFO   -->  PHY_STUB: Forming RRC REGISTRATION COMPLETE PDU");
	  uint8_t  pduLen = 12;
	  ...
	  */
      ...
      {
         DU_LOG("\nINFO   -->  PHY_STUB: Forming RRC RECONFIGURATION COMPLETE PDU");
         uint8_t  pduLen = 14;
	 /* For rrc reconfig complete where RRC Container is dummy
	 MAC subheader format is R/F/LCId/L (2/3 bytes)
	 LCId is 1 for SRB1
...
S16 l1HdlUlTtiReq(uint16_t msgLen, void *msg)
{
   ...
   if(numPdus == 0)
   {
      DU_LOG("\nDEBUG  -->  PHY STUB: No PDU received in UL TTI Req");
   }
   else
   {
      DU_LOG("\nDEBUG  -->  PHY STUB: Received UL TTI Request");
   }
#endif 
...
S16 l1HdlStopReq(uint32_t msgLen, void *msg)
{
   ...
   {
      DU_LOG("\nERROR  -->  PHY_STUB: Received Stop Req in PHY State %d", lwrMacCb.phyState);
      MAC_FREE(msg, msgLen);
      return RFAILED;
   }
#endif
