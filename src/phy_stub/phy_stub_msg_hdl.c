...
uint16_t l1BuildAndSendRxDataInd(uint16_t slot, uint16_t sfn, fapi_ul_pusch_pdu_t puschPdu)
{
   ...
   else
   {
      ...
      else if(!phyDb.ueDb.ueCb[ueId-1].msgAuthenticationRspComp)
      {
         phyDb.ueDb.ueCb[ueId-1].msgAuthenticationRspComp = true;
         type = MSG_TYPE_AUTHENTICATION_REPSONSE_COMPLETE;
      }
   ...
   switch(type)
   {
      ...
      case MSG_TYPE_AUTHENTICATION_REPSONSE_COMPLETE:
      {
