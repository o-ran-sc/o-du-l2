...
typedef struct schRachCfg
{
   ...
   uint8_t      prachLongFormat;  /* Support for PRACH long format */
   uint16_t     prachShortFormat; /* Support for PRACH short format */
...
//   uint16_t     rootSeqIdx;        /* Root sequence index */dd
