...
EXTERN uint8_t packSchCellCfg(Pst *pst, SchCellCfg  *schCellCfg);
EXTERN uint8_t packSchCellCfgCfm(Pst *pst, SchCellCfgCfm  *schCellCfgCfm);
EXTERN uint8_t MacProcDlAlloc(Pst *pst, DlSchedInfo *dlSchedInfo);
EXTERN uint8_t MacProcSchCellCfg(Pst *pst, SchCellCfg  *schCellCfg);
EXTERN uint8_t MacProcSchCellCfgCfm(Pst *pst, SchCellCfgCfm  *schCellCfgCfm);
EXTERN uint8_t SchHdlCellCfgReq(Pst *pst, SchCellCfg *schCellCfg);
EXTERN uint8_t schActvInit(Ent entity, Inst instId, Region region, Reason reason);
EXTERN uint8_t SchSendCfgCfm(Pst *pst, RgMngmt *cfm);
EXTERN uint8_t MacProcUlSchInfo(Pst *pst, UlSchedInfo *ulSchedInfo);
