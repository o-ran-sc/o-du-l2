...
#define MAX_NUM_PDCCH 2 /*As per SCF222_5GFAPI, 'MaxDciPerSlot' defines this value but this parameter value is missing in Spec.*/
...
typedef struct pdcchCfg
{
   ...
   uint16_t   numDlDci;
   DlDCI      dci[MAX_NUM_PDCCH]; /* as of now its only one DCI, later it will be numDlCi */
} PdcchCfg;
