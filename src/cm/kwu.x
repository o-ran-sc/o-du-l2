...
typedef S16 (*KwuFlowCntrlInd)ARGS((Pst *pst, SuId suId, RlcuFlowCntrlIndInfo* flowCntrlInd));
...
EXTERN S16 cmPkRlcuFlowCntrlIndInfo ARGS((
RlcuFlowCntrlIndInfo *param,
Buffer              *mBuf
));

EXTERN S16 cmUnpkRlcuFlowCntrlIndInfo ARGS((
RlcuFlowCntrlIndInfo *param,
Buffer              *mBuf
));
