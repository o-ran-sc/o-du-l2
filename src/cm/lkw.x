...
typedef S16 (*LrlcCfgReq)   ARGS((Pst *pst, KwMngmt *cfg));
typedef S16 (*LrlcCfgCfm)   ARGS((Pst *pst, KwMngmt *cfgCfm));
...
*/
EXTERN S16 KwMiLrlcCfgReq ARGS((Pst *pst, KwMngmt *cfg));

/**
@details This function is called by the KwMiLrlcCfgReq function for responding to configuration requests.The cfm field in the KwMngmt  structure contains the response value.

@param[in] pst  - Pointer to post structure
@param[in] cfm  - Configuration management structure
@return ROK if success , RFAILED if failure
*/
EXTERN S16 KwMiLrlcCfgCfm ARGS((Pst *pst, KwMngmt *cfgCfm));
...
#ifdef SM
EXTERN S16 SmMiLrlcCfgCfm   ARGS((
       Pst *,
       KwMngmt *
       ));
...
EXTERN S16 SmMiLrlcCfgReq   ARGS((
       Pst *,
       KwMngmt *
       ));
...
#ifdef LCLKW 
EXTERN S16 cmPkLrlcCfgReq     ARGS((
       Pst *,
       KwMngmt *
       ));

EXTERN S16 cmPkLrlcCfgCfm     ARGS((
       Pst *,
       KwMngmt *
       ));
...
EXTERN S16 cmUnpkLrlcCfgReq   ARGS((
       LrlcCfgReq,
       Pst *,
       Buffer *
       ));

EXTERN S16 cmUnpkLrlcCfgCfm   ARGS((
       LrlcCfgCfm,
       Pst *,
       Buffer *
       ));
