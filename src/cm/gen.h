...
#define cmPkchNo(x, mBuf)       packUint8(x, mBuf)       /* pack Channel Number */
...
#define cmPkNwId(x, mBuf)       packUint16(x, mBuf)      /* pack NwId */
...
#define cmPkUConnId(x, mBuf)    packUint32(x, mBuf)      /* pack unsigned ConnId */
#define cmPkMibOpCode(x, mBuf)  packUint16(x, mBuf)      /* pack mib opCode*/
#define cmPkMibStatus(x, mBuf)  packUint16(x, mBuf)      /* Pack mib cfm status*/
#define cmPkMibTblType(x, mBuf) packUint16(x, mBuf)      /* Pack mib table type */
#define cmPkMibReqId(x, mBuf)   SPkS32(x, mBuf)      /* Pack mib request Id */
#define cmPkProfileId(x, mBuf)  packUint8(x, mBuf)       /* Pack HCC Profile Id */
#define cmPkIntfId(x, mBuf)     packUint16(x, mBuf)      /* Pack intf id  */
#define cmPkIntfVer(x, mBuf)    packUint16(x, mBuf)      /* Pack intf ver */
#define cmPkuaType(x, mBuf)     packUint8(x, mBuf)      /* Pack uaType */
...
#define cmPkOui(x, mBuf)        packUint32(x, mBuf)       /* pack Oui */
#define cmPkPid(x, mBuf)        packUint16(x, mBuf)       /* pack Pid */
#define cmPkLlcId(x, mBuf)      packUint32(x, mBuf)       /* pack LLcId */
...
#define cmUnpkNwId(x, mBuf)       unPackUint16(x, mBuf)  /* unpack NwId */
...
#define cmUnpkUConnId(x, mBuf)    unPackUint32(x, mBuf)  /* unpack uns ConnId */
#define cmUnpkMibOpCode(x, mBuf)  unPackUint16(x, mBuf)  /* unpack mib opCode*/
#define cmUnpkMibStatus(x, mBuf)  unPackUint16(x, mBuf)  /* unpack mib cfm status*/
#define cmUnpkMibTblType(x, mBuf) unPackUint16(x, mBuf)  /* Pack mib table type */
#define cmUnpkMibReqId(x, mBuf)   SUnpkS32(x, mBuf)  /* Pack mib request Id */
#define cmUnpkProfileId(x, mBuf)  unPackUint8(x, mBuf)   /* Pack HCC Profile Id */
#define cmUnpkIntfId(x, mBuf)     unPackUint16(x, mBuf)      /* unpack intf id  */
#define cmUnpkIntfVer(x, mBuf)    unPackUint16(x, mBuf)      /* unpack intf ver */
#define cmUnpkuaType(x, mBuf)     unPackUint8(x, mBuf)       /* Unpack uaType */
/* scc specific typedefs */
...
#define cmUnpkOui(x, mBuf)         unPackUint32(x, mBuf)  /* unpack Oui */
#define cmUnpkPid(x, mBuf)         unPackUint16(x, mBuf)  /* unpack Pid */
#define cmUnpkLlcId(x, mBuf)       unPackUint32(x, mBuf)  /* unpack LLcId */
...
#define cmPkTranId(x, mBuf)    packUint32(x, mBuf)      /* Pack transaction Id */
#define cmUnpkTranId(x, mBuf)    unPackUint32(x, mBuf)  /* unpack transaction Id */
