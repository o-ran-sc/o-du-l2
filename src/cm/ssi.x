...
struct ss_buffer                  /* buffer - typdef'd earlier */
{
   ...
   union {
      ...
      struct
      {
         ...
         uint32_t wsuint32_t[2];            /* workspace unsigned 32 bit values (optional) */
         uint16_t wsuint16_t[1];            /* workspace unsigned 16 bit values (optional) */
         uint8_t  wsuint8_t[2];             /* workspace unsigned 8 bit values (optional) */
      } msg;                      /* message buffer */
