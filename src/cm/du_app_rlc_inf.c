...
uint8_t packDuRlcUeCreateReq(Pst *pst, RlcUeCfg *ueCfg)
{
   ...
   {
      DU_LOG("\nDEBUG  -->  RLC: Only LWLC supported for packDuRlcUeCreateReq");
      return RFAILED;
   }
...
uint8_t unpackRlcUeCreateReq(DuRlcUeCreateReq func, Pst *pst, Buffer *mBuf)
{
   ...
   else
   {
      ...
      DU_LOG("\nDEBUG  -->  RLC: Only LWLC supported for UE Create Request ");
      ODU_PUT_MSG_BUF(mBuf);
   }
...
uint8_t packRlcDuUeCfgRsp(Pst *pst, RlcUeCfgRsp *ueCfg)
{
   ...
   {
      DU_LOG("\nDEBUG  -->  RLC: Only LWLC supported for packRlcDuUeCfgRsp");
      return RFAILED;
   }
...
uint8_t unpackRlcUeCfgRsp(RlcDuUeCfgRsp func, Pst *pst, Buffer *mBuf)
{
   ...
   {
      /* Nothing to do for other selectors */
      DU_LOG("\nDEBUG  -->  RLC: Only LWLC supported for UE Cfg Response ");
      ODU_PUT_MSG_BUF(mBuf);
   }
...
uint8_t packRlcUlRrcMsgToDu(Pst *pst, RlcUlRrcMsgInfo *ulRrcMsgInfo)
{
   ...
   {
      DU_LOG("\nDEBUG  -->  RLC: Only LWLC supported for packRlcUlRrcMsgToDu");
   }
   return RFAILED;
}
...
uint8_t unpackRlcUlRrcMsgToDu(RlcUlRrcMsgToDuFunc func, Pst *pst, Buffer *mBuf)
{
   ...
   {
      /* Nothing to do for other selectors */
      DU_LOG("\nDEBUG  -->  RLC: Only LWLC supported for UL RRC Message transfer ");
      ODU_PUT_MSG_BUF(mBuf);
   }
...
uint8_t packDlRrcMsgToRlc(Pst *pst, RlcDlRrcMsgInfo *dlRrcMsgInfo)
{
   ...
   {
      DU_LOG("\nDEBUG  -->  RLC: Only LWLC supported for packDlRrcMsgToRlc");
   }
   return RFAILED;
}
...
uint8_t packRrcDeliveryReportToDu(Pst *pst, RrcDeliveryReport *rrcDeliveryReport)
{
    ...
    {
       DU_LOG("\nDEBUG  -->  RLC: Only LWLC supported for packRrcDeliveryReportToDu");
    }
    return RFAILED;
 }
...
uint8_t unpackRrcDeliveryReportToDu(RlcRrcDeliveryReportToDuFunc func, Pst *pst, Buffer *mBuf)
{
    ...
    {
       /* Nothing to do for other selectors */
       DU_LOG("\nDEBUG  -->  RLC: Only LWLC supported for RRC delivery Message transfer ");
       ODU_PUT_MSG_BUF(mBuf);
    }
...
uint8_t packDuRlcUeReconfigReq(Pst *pst, RlcUeCfg *ueCfg)
{
   ...
   {
      DU_LOG("\nDEBUG  -->  RLC: Only LWLC supported for packDuRlcUeReconfigReq");
      return RFAILED;
   }
...
uint8_t packRlcDlRrcMsgRspToDu(Pst *pst, RlcDlRrcMsgRsp *dlRrcMsgRsp)
{
   ...
   {
      DU_LOG("\nDEBUG  -->  RLC: Only LWLC supported for packRlcDlRrcMsgRspToDu");
   }
   return RFAILED;
}
...
uint8_t unpackRlcDlRrcMsgRspToDu(RlcDlRrcMsgRspToDuFunc func, Pst *pst, Buffer *mBuf)
{
   ...
   {
      /* Nothing to do for other selectors */
      DU_LOG("\nDEBUG  -->  RLC: Only LWLC supported for DL RRC Message transfer ");
      ODU_PUT_MSG_BUF(mBuf);
   }
   return RFAILED;
}
