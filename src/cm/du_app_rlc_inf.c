...
* @details
*
*    Function : packRrcDeliveryReportMsgToDu
*
*    Functionality:
*      Unpacks the DL RRC Message info received at RLC from DU APP
*
...
uint8_t packRrcDeliveryReportMsgToDu(Pst *pst, RrcDeliveryReportInfo *rrcDeliveryMsg)
{
    ...
    if(pst->selector == ODU_SELECTOR_LWLC)
    {
       if (ODU_GET_MSG_BUF(pst->region, pst->pool, &mBuf) != ROK)
       {
          DU_LOG("\nRLC : Memory allocation failed at packRrcDeliveryReportMsgToDu");
          return RFAILED;
       }
       /* pack the address of the structure */
    ...
    {
       DU_LOG("\nRLC: Only LWLC supported for packRrcDeliveryReportMsgToDu");
    }
    return RFAILED;
 }
...
* @details
*
*    Function : unpackRrcDeliveryReportMsgToDu
*
*    Functionality:
