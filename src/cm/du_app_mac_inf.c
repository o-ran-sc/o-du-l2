...
uint8_t packMacUlCcchInd(Pst *pst, UlCcchIndInfo *ulCcchIndInfo)
{
   ...
   {
      DU_LOG("\nDEBUG  -->  MAC: Only LWLC supported for UL CCCH Ind ");
      return RFAILED;
   }
...
uint8_t packMacDlCcchInd(Pst *pst, DlCcchIndInfo *dlCcchIndInfo)
{
   ...
   {
      DU_LOG("\nDEBUG  -->  DU APP : Only LWLC supported for DL CCCH Ind ");
      return RFAILED;
   }
...
uint8_t packDuMacUeCreateReq(Pst *pst, MacUeCfg *ueCfg)
{
   ...
   {
      DU_LOG("\nDEBUG  -->  MAC: Only LWLC supported for packDuMacUeCreateReq");
      return RFAILED;
   }
...
uint8_t unpackMacUeCreateReq(DuMacUeCreateReq func, Pst *pst, Buffer *mBuf)
{
   ...
   {
      /* Nothing to do for other selectors */
      DU_LOG("\nDEBUG  -->  DU APP : Only LWLC supported for UE Create Request ");
      ODU_PUT_MSG_BUF(mBuf);
   }
...
uint8_t packDuMacUeCfgRsp(Pst *pst, MacUeCfgRsp *cfgRsp)
{
   ...
   {
      DU_LOG("\nDEBUG  -->  MAC: Only LWLC supported for packDuMacUeCfgRsp");
      return RFAILED;
   }
...
uint8_t packDuMacUeReconfigReq(Pst *pst, MacUeCfg *ueCfg)
{
   ...
   {
      DU_LOG("\nDEBUG  -->  MAC: Only LWLC supported for packDuMacUeReconfigReq");
      return RFAILED;
   }
