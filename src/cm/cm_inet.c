...
#endif
{
   ...
   {
      memset((U8*)&srcAddr6, 0, sizeof(srcAddr6));
   ...
   {
      memset((U8*)&srcAddr, 0, sizeof(srcAddr));
...
#endif
{
   ...
   memset((U8*)&addrs, 0, (sizeof(struct sockaddr_in) * CM_INET_NUM_NET_ADDR));
#ifdef IPV6_SUPPORTED 
   memset((U8*)&addrs6, 0, (sizeof(struct sockaddr_in6) * CM_INET_NUM_NET_ADDR));
#endif /* IPV6_SUPPORTED */
   ...
   for (idx = 0; idx < addrLst->count; idx++)
   {
      ...
      else 
      {
         ...
         memcpy((U8*)(ipv4Format+7), (U8*)addrString, addrLen);
   ...
   if(ipv4_array_size > 0)
   {
      ...
      memcpy((U8*)address_array, (U8*)addrs, ipv4_array_size); 
   }
#ifdef IPV6_SUPPORTED
   else
   {
   ...
   {
      memcpy((U8*)(address_array + ipv4_array_size), (U8*)addrs6, ipv6_array_size); 
   }
#endif /* IPV6_SUPPORTED */
...
/* cm_inet_c_001.main_64: New variable used as an argument for sctp_connectx */
   ...
   {
      memcpy((U8*)address_array, (U8*)&addrs[0], ipv4_array_size); 
   }
   else
   {
      return RFAILED;
...
#endif
{
 ...
 /* cm_inet_c_001.main_58 : Fix for klockwork issue */
   ...
   memset((U8*)&addr, 0, sizeof(struct sockaddr_in));
#ifdef IPV6_SUPPORTED
   memset((U8*)&addr6, 0, sizeof(struct sockaddr_in6));
#endif /* IPV6_SUPPORTED */
...
#endif
{
   ...
   *mBuf = NULLP;
   *len  = 0;
   memset((U8*)ntfy, 0, sizeof(CmInetSctpNotification));
   ...
   msgFlags = 0;
   memset((U8*)&addr, 0, sizeof(struct sockaddr_storage));
   memset((U8*)&info, 0, sizeof(struct sctp_sndrcvinfo));
   ...
   *len = (MsgLen)ret;
   ...
   if (addr.ss_family == AF_INET6)
   {
      ...
      if((cmMemcmp(ipv4Format, pAddr6->sin6_addr.s6_addr, 12)) == 0)
      {
         ...
         memcpy((U8*)&srcAddr->u.ipv4NetAddr, (U8*)((pAddr6->sin6_addr.s6_addr) + 12), sizeof(U32));
...
/*cm_inet_c_001.main_40 Updated for the support of configurable RTO parameters, 
   ...
   switch (type) 
   {
      case CM_INET_OPT_SCTP_GET_ASSOC_STA:
         ...
         memset((U8*)&status, 0, sizeof(struct sctp_status));
         len = sizeof(status);
      ...
      case CM_INET_OPT_SCTP_GET_PADDR_INFO:
         ...
         memset((U8*)&addrInfo, 0, sizeof(struct sctp_paddrinfo));
         len = sizeof(addrInfo);
      ...
      case CM_INET_OPT_SCTP_PEERADDR_PARAMS:
         ...
         memset((U8*)&addrParams, 0, sizeof(struct sctp_paddrparams));
      ...
      case CM_INET_OPT_SCTP_ASSOC_PARAMS:
         ...
         memset((U8*)&assocParams, 0, sizeof(struct sctp_assocparams));
      ...
      case CM_INET_OPT_SCTP_RTO_INFO:
         ...
         memset((U8*)&rtoInfo, 0, sizeof(struct sctp_rtoinfo));
      ...
      case CM_INET_OPT_SCTP_INIT_MSG:
         ...
         memset((U8*)&initMsg, 0, sizeof(struct sctp_initmsg));
...
#endif
{
   ...
   memset((U8*)&sndRcvInfo, 0, sizeof(sndRcvInfo));
...
#endif
{
   ...
   {
      memset((U8*)&dstAddr6, 0, sizeof(dstAddr6));
   ...
   {
      memset((U8*)&dstAddr, 0, sizeof(dstAddr));
...
#ifdef IPV6_SUPPORTED
   memset((U8*)fromAddr, 0, sizeof(fromAddr));
   if (addrLen == sizeof(struct sockaddr_in))
   {
...
#if !(defined(WIN32) || defined(CMINETFLATBUF))
#if (defined(SS_LINUX) || defined(_XPG4_2))
/*   memset((U8*)cmsgData, 0, sizeof(cmsgData));    */
#endif /* SS_LINUX || _XPG4_2 */
   curMsgIdx   = 0;
#endif /* WIN32 | CMINETFLATBUF */
   ...
   if (dstAddr != NULLP)
   {
      ...
      if (dstAddr->type == CM_INET_IPV6ADDR_TYPE)
      {
         memset((U8*)&remAddr6, 0, sizeof(remAddr6));
      ...
      {
         memset((U8*)&remAddr, 0, sizeof(remAddr));
...
#endif /* ANSI */
{
   ...
   {  
      /* store ipv6 src addr */ 
      memcpy((U8 *)&(ipv6Pktinfo->ipi6_addr), (U8 *)srcAddr, 16);
      len += 16;
...
#endif /* ANSI */
{
   ...
   for (;;)   
   {
      ...
      {   
         ...
         memcpy((U8 *)hbhOptsArr->hbhOpts[optsIdx].value, 
...
#endif /* ANSI */
{
   ...
   {
      memcpy((U8 *)(rtOptsArr->ipv6Addrs[i]),
...
#if (defined(SS_LINUX) || defined(_XPG4_2))
   memset((U8*)ancillData, 0, sizeof(ancillData));
#endif /* SS_LINUX || _XPG4_2 */

#endif /* (WIN32 | CMINETFLATBUF) */

   /* clear the structure */   
   memset((U8*)&remSockAddr, 0, sizeof(remSockAddr));
         ...
         if (cmsgptr != NULLP) 
         {
            ...
            {   
               if(cmsgptr->cmsg_type == IPV6_PKTINFO)
               {
                  ...
                  memcpy((U8 *)&localIf->localIfAddr.u.ipv6NetAddr,
  ...
  struct icmp_filter icmpFilter; 
   ...
   switch (type)
   {
      ...
      case CM_INET_OPT_LINGER:
         ...
         memset((U8*)&lngr, 0, sizeof(struct linger));
      ...
      case CM_INET_OPT_SCTP_EVENTS:
         ...
         memset((U8*)&event, 0, sizeof(struct sctp_event_subscribe));
      ...
      case CM_INET_OPT_SCTP_PRIM_ADDR:
         ...
         memset((U8*)&setPrim, 0, sizeof(struct sctp_setprim));
...
#endif
{
   ...
   memcpy((U8*)address6, (U8*)&(((struct sockaddr_in6 *)&ss)->sin6_addr), sizeof(CmInetIpAddr6));
#endif /* WIN32 */
...
#endif
{
   ...
   memset((U8*)&lclSockAddr, 0, sizeof(lclSockAddr));
...
#ifdef IPV6_SUPPORTED
   memset((U8*)locAddr, 0, sizeof(CmInetAddr));
...
#endif
{
   ...
   memset((U8 *)ipv6Reg, 0, CM_INET_IPV6ADDR_SIZE);
   memset((U8 *)ipv6Cmp, 0, CM_INET_IPV6ADDR_SIZE);
#endif /* IPV6_SUPPORTED*/

   memset((U8 *)ipv4, 0, CM_INET_IPV4ADDR_SIZE);
   ...
   else 
   {
      ...
      memcpy((U8 *)address->u.ipv6NetAddr,
...
#endif /* ANSI */
{
   ...
   while (curLen > 0)
   {
      memset((U8*)recvTempBuf, 0, CM_INET_MAX_BYTES_READ);
      /* added separate recvfrom calls different OS */
