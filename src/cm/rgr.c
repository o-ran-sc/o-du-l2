...
#endif
{
   ...
   cmMemset((uint8_t *)cfgReqInfo, 0, sizeof(RgrCfgReqInfo));
...
#endif
{
   ...
   cmMemset((uint8_t *)cfgReqInfo, 0, sizeof(RgrSiCfgReqInfo));
   if (pst->selector == ODU_SELECTOR_LC) 
...
#endif
{
   ...
   cmMemset((uint8_t *)loadInfReq, 0, sizeof(RgrLoadInfReqInfo));
