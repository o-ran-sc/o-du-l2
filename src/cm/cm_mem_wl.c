...
)
{
   ...
   {
      DU_LOG("\nERROR  --> CM: cmDynAlloc(): Received memory region or size or block is invalid");
      return RFAILED;
   }
#endif
...
/*  cm_mem_c_001.main_15 : Additions */
   ...
   if ((regCb == NULLP) || (size == NULLP) || !(*size) || (ptr == NULLP))
   {
      DU_LOG("\nERROR  --> CM : cmAlloc(): Received memory region or size or block is invalid");
      return RFAILED;
   }
#endif
...
)
{
   ...
   {
      DU_LOG("\nERROR --> CM : cmDynFree(): Received memory region or size or block is invalid");
      return RFAILED;
   }
...
/*  cm_mem_c_001.main_15 : Additions */
   ...
   if ((regCb == NULLP) || (!size) || (ptr == NULLP))
   {
      DU_LOG("\nERROR --> CM : cmFree(): Received memory region or size or block is invalid");
      return RFAILED;
   }
