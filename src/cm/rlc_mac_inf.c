 ...
 *      -# ROK
 **/
uint8_t packRlcSchResultRep(Pst* pst, RlcSchResultRep *schRep)
{
   uint8_t   lcIdx;
   Buffer *mBuf = NULLP;
 ...
 *      -# ROK
 **/
uint8_t unpackSchResultRep(RlcMacSchResultRepFunc func, Pst *pst, Buffer *mBuf)
{
   uint8_t   lcIdx;
   RlcSchResultRep *schRep;
   ...
   {
      RlcSchResultRep schReport;
      schRep = &schReport;
      memset(schRep, 0, sizeof(RlcSchResultRep));
