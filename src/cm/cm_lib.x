...
U8 *cmMemcpy      ARGS((U8 *tgt, const U8 *src, PTR len));
S16 cmMemcmp      ARGS((const U8 *s1, const U8 *s2, PTR len));
U8 *cmMemset      ARGS((U8 *src, U8 val, PTR len));

S16 cmStrcmp      ARGS((const U8 *s1, const U8 *s2));
/* cm_lib_x_001.main_8:Changing from S16 to MsgLen.*/
S16 cmStrncmp     ARGS((const U8 *s1, const U8 *s2, MsgLen len));
MsgLen cmStrlen   ARGS((const U8 *s));
