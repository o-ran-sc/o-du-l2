...
#define EVENT_MAC_PAGING_REQ         223
#define EVENT_MAC_PAGING_RSP         224
...
typedef uint8_t (*DuMacPagingReq) ARGS((
     Pst        *pst,
     MacPageReq *pagingReq));

/* Paging Response from MAC to DUAPP */
typedef uint8_t (*MacDuPagingRspFunc) ARGS((
   Pst           *pst,
