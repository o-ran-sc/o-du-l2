...
typedef struct cellStartInfo
{
    SlotTimingInfo slotInfo;
    uint16_t       cellId;
}CellStartInfo;

typedef struct cellStartInfo CellStopInfo;
...
uint8_t packMacCellStart(Pst *pst, CellStartInfo *cellId);
uint8_t unpackMacCellStart(DuMacCellStart func, Pst *pst, Buffer *mBuf);
uint8_t MacProcCellStart(Pst *pst, CellStartInfo *cellId);
uint8_t packMacCellStop(Pst *pst, CellStopInfo *cellId);
uint8_t unpackMacCellStop(DuMacCellStop func, Pst *pst, Buffer *mBuf);
uint8_t MacProcCellStop(Pst *pst, CellStopInfo *cellId);
...
uint8_t DuProcMacSliceReCfgRsp(Pst *pst,  MacSliceReCfgRsp *cfgRsp);
