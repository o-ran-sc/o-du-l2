 ...
 * @return ROK
 */
S16 RlcUiCkwBndCfm ARGS((Pst *pst, SuId suId, U8 status));
 ...
 * @return ROK
 */
S16 RlcUiCkwUeIdChgReq ARGS((Pst *pst, SpId spId, U32 transId,
                                   CkwUeInfo *ueInfo, CkwUeInfo *newUeInfo));
 ...
 * @return ROK
 */
S16 RlcUiCkwUeIdChgCfm  ARGS((Pst *pst, SuId suId, U32 transId, 
                                   CkwUeInfo *ueInfo, CmStatus status));
