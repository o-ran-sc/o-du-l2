...
#define CM_HASH_KEYTYPE_uint32_tMOD      4  /* Mods the key with number of bins
...
#define CM_HASHKEYLEN_uint32_t              sizeof(uint32_t)  /* size of uint32_t */
#define CM_HASHKEYLEN_uint16_t              sizeof(uint16_t)  /* size of uint16_t */
#define CM_HASHKEYLEN_uint8_t               sizeof(uint8_t)  /* size of uint8_t */
