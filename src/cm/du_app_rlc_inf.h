...
uint8_t packRlcDuUeReestablishRsp(Pst *pst, RlcUeReestablishRsp *ueReestablishmentRsp);
...
uint8_t RlcProcUeReestablishReq(Pst *pst, RlcUeReestablishReq *ueReestablishment);
