...
#define EVENT_RLC_UL_UE_RECONFIG_REQ  215
#define EVENT_RLC_UL_UE_RECONFIG_RSP  216
...
typedef struct rlcUeCfg
{
   ...
   uint8_t      ueIdx;
   uint8_t      numLcsToAdd;
   RlcBearerCfg rlcBearerCfgToAdd[MAX_NUM_LC];
   uint8_t      numLcsToMod;
   RlcBearerCfg rlcBearerCfgToMod[MAX_NUM_LC];
   uint8_t      numLcsToDel;
   RlcBearerCfg rlcBearerCfgToDel[MAX_NUM_LC];
}RlcUeCfg;
