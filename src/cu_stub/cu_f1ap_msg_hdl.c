...
uint8_t procUeContextSetupResponse(uint32_t duId, F1AP_PDU_t *f1apMsg, char *recvBuf, MsgLen recvBufLen)
{
          ...
          case ProtocolIE_ID_id_gNB_DU_UE_F1AP_ID:
             {
                ...
                if(ueCb->gnbDuUeF1apId == 0)
                {
                   ...
                   if(duDb->tempUeCtxtInHo.gnbCuUeF1apId == cuUeF1apId)
                   {
   ...
   else if(ueCb->state == UE_HANDOVER_IN_PROGRESS && ueCb->hoInfo.HOType == Inter_DU_HO)
   {
   ...
   else if(ueCb->state == UE_HANDOVER_IN_PROGRESS && ueCb->hoInfo.HOType == Xn_Based_Inter_CU_HO)
   {
 ...
 *
 * ****************************************************************/
uint8_t procUeContextModificationResponse(uint32_t duId, CuUeCb *tempUeCtxt, F1AP_PDU_t *f1apMsg, char *recvBuf, MsgLen recvBufLen)
{
               ...
               case SuccessfulOutcome__value_PR_UEContextModificationResponse:
                  {
                     ...
                     procUeContextModificationResponse(*duId, NULLP, f1apMsg, recvBuf, recvBufLen);
                     break;
                  }
