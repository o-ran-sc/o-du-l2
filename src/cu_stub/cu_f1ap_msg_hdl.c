...
* @details
*
*    Function : procServeCellPlmnList
*
*    Functionality:
...
*
* ****************************************************************/
uint8_t procServeCellPlmnList(ServedPLMNs_List_t *srvPlmn)
{
                           ...
                           case ProtocolIE_ID_id_TAISliceSupportList:
                              {
                                 ...
                                 {
                                    DU_LOG("\nERROR  --> CU_STUB: procServeCellPlmnList(): Failed to build slice List");
                                    return RFAILED;
                                 }
                              }
                        }
                     ...
                     if(duServedCell->list.array[plmnidx])
                     {
                        switch(duServedCell->list.array[plmnidx]->id)
                        {
                           case ProtocolIE_ID_id_GNB_DU_Served_Cells_Item:
                           {
                              ...
                              ret = procServeCellPlmnList(&srvCellItem->served_Cell_Information.servedPLMNs);
                           }
                        }
                     }
                  }
