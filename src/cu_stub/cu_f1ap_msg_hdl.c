...
uint8_t BuildAndSendF1ResetReq()
{
    ...
    do
    {
       ...
       f1ResetMsg->protocolIEs.list.array[idx]->value.choice.Cause.present = Cause_PR_protocol;
       f1ResetMsg->protocolIEs.list.array[idx]->value.choice.Cause.choice.protocol = CauseProtocol_unspecified;
