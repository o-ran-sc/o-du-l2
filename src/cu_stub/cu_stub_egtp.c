...
/*******************************************************************
 *
 * @brief This function handles the EGTP Data request
 *
 * @details
 *
 ...
 * 
 *    Functionality:
 *       This function handles the EGTP Data request 
 *
 * @params[in] uint8_t numDu, uint8_t teId
 *
 * @return ROK     - success
 *         RFAILED - failure
 *
 * ****************************************************************/
uint16_t cuEgtpDatReq(uint8_t numDu, uint8_t teId)
{
...
/*******************************************************************
 *
 * @brief Build the application message
 *
 * @details
 *
