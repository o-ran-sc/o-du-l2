...
#define P7_PNF_ADD_IPV4              0x0103
#define P7_PNF_ADD_IPV6              0x0104
#define P7_PNF_PORT                  0x0105
#define P7_VNF_ADD_IPV4              0x0100
#define P7_VNF_ADD_IPV6              0x0101
#define P7_VNF_PORT                  0x0102
#define P7_TRANSPORT                 0x0122
#define P7_PNF_ETHERNET_ADD          0x0123
#define ECPRI_MSG_TYPE               0x0125
#define ECPRI_PHY_TRANSPORT_ID       0x0126
#define DL_TTI_TIMING_OFFSET         0x0106
#define UL_TTI_TIMING_OFFSET         0x0107
#define UL_DCI_TIMING_OFFSET         0x0108
#define TX_DATA_TIMING_OFFSET        0x0109
#define TIMING_WINDOW                0x011E
#define TIMING_INFO_MODE             0x011F
#define TIMING_INFO_PERIOD           0x0120
#define P7_IP_FRAGMENTATION_ALLOWED  0x0121
#define 5G_FAPI_MSG_BODY             0x0F00

typedef enum nFapi_pnf_states_t{
   PNF_STATE_IDLE = 0,
...
typedef enum nfapi_error_code_t{
   MSG_OK = 0,
   MSG_INVALID_STATE,
   MSG_INVALID_CONFIG
}nfapi_error_code;
