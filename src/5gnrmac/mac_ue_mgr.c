...
uint8_t MacSendUeDeleteRsp(uint16_t cellId, uint16_t crnti, Cause result)
{
...
uint8_t MacSendUeResetRsp(uint16_t cellId, uint16_t ueId, Cause result)
{
