 ...
 *
 * @params[in] macCellGrp : ue configuration at MAC
 *             *macCellGrpCfg : scheduler UE cfg to fill
 * @return ROK     - success
 *         RFAILED - failure
 *
 * ****************************************************************/
uint8_t fillMacCellGroupCfg(MacCellGrpCfg macCellGrp, SchMacCellGrpCfg  *macCellGrpCfg)
{
   ...
   /* Copy PHR config */
   macCellGrpCfg->phrCfg = NULL;
   if(macCellGrp.phrCfgSetupPres)
   {
      phrCfg = macCellGrpCfg->phrCfg;
      phrCfg->periodicTmr = macCellGrp.phrCfg.periodicTimer;
      phrCfg->prohibitTmr =  macCellGrp.phrCfg.prohibitTimer;
      phrCfg->txpowerFactorChange = macCellGrp.phrCfg.txPowerFactor;
      phrCfg->multiplePhr = macCellGrp.phrCfg.multiplePHR;
      phrCfg->dummy = macCellGrp.phrCfg.dummy;
      phrCfg->type2OtherCell = macCellGrp.phrCfg.phrType2OtherCell;
      phrCfg->modeOtherCG = macCellGrp.phrCfg.phrOtherCG;
   }
 ...
 *
 * @params[in] macUeCfg : UE config at MAC
 *             *schPhyCellGrp : scheduler UE cfg to fill
 * @return ROK     - success
 *         RFAILED - failure
 *
 * ****************************************************************/
 ...
 *
 * @params[in] macPdschCfg : UE cfg in MAC
 *             *schPdschCfg : UE cfg to be filled for scheduler
 * @return ROK     - success
 *         RFAILED - failure
 *
 * ****************************************************************/
 ...
 *
 * @params[in] macPuschCfg : MAC UE cfg
 *             schPuschCfg : UE cfg to be filled to send to sch
 * @return ROK     - success
 *         RFAILED - failure
 *
 * ****************************************************************/
 ...
 *
 * @params[in] macInitUlBwp : UE cfg at MAC
 *             schInitUlBwp : UE config to fill to send to sch
 * @return ROK     - success
 *         RFAILED - failure
 *
 * ****************************************************************/
 ...
 *
 * @params[in] macPdcchCfg : UE cfg in MAC
 *             schPdcchCfg : UE config to fill for scheduler
 * @return ROK     - success
 *         RFAILED - failure
 *
 * ****************************************************************/
 ...
 *
 * @params[in] macPdschCfg : UE cfg in MAC
 *             schPdschCfg : UE config to fill for scheduler
 * @return ROK     - success
 *         RFAILED - failure
 *
* ****************************************************************/
 ...
 *
 * @params[in] macInitDlBwp : MAC UE cfg
 *             schInitDlBwp : UE cfg to be filled for SCH
 * @return ROK     - success
 *         RFAILED - failure
 *
 * ****************************************************************/
 ...
 *
 * @params[in] macLcCfg : MAC UE Cfg
 *             schLcCfg : UE Cfg to fill at scheduler
 * @return ROK     - success
 *         RFAILED - failure
 *
 * ****************************************************************/
...
uint8_t createUeCb(MacUeCfg *ueCfg)
{
   ...
   for(lcIdx = 0; lcIdx < ueCfg->numLcs; lcIdx++)
   {
	...
	for(ueIdx = 0; ueIdx < MAX_UE; ueIdx++)
	{
      ...
      {
		   memcpy(&ueCb->raCb, &macCb.macCell->macRaCb[ueIdx], sizeof(MacRaCbInfo));
			break;
		}
	}
