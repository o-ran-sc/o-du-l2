...
uint8_t fillOtherPucchFormatCfg(uint8_t pucchFormat, PucchFormatCfg *macFormatCfg, SchPucchCfg *schPucchCfg)
{
   ...
   switch(pucchFormat)
   {
         ...
         if(macFormatCfg)
	 {
            ...
            {
               DU_LOG("\nMAC: Failed to allocate Mem for Format 1 in fillOtherPucchFormatCfg()");
               return RFAILED;
            }
         ...
         if(macFormatCfg)
	 {
            ...
            {
               DU_LOG("\nMAC: Failed to allocate Mem for Format 2 in fillOtherPucchFormatCfg()");
               return RFAILED;
            }
      ...
      case PUCCH_FORMAT_3:
      {
         if(macFormatCfg)
         {
            ...
            {
               DU_LOG("\nMAC: Failed to allocate Mem for Format 3 in fillOtherPucchFormatCfg()");
               return RFAILED;
            }
      ...
      case PUCCH_FORMAT_4:
      {
         if(macFormatCfg)
         {
            ...
            {
               DU_LOG("\nMAC: Failed to allocate Mem for Format 4 in fillOtherPucchFormatCfg()");
               return RFAILED;
            }
      ...
      default:
         DU_LOG("\nMAC: Invalid Format Cfg %d in fillInitialUlBwpPucchCfg()", pucchFormat);
         return RFAILED;
   }
}
