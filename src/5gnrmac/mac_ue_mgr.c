...
{
   packDuMacUeReconfigRsp,       /* packing for loosely coupled */
   DuHandleMacUeReconfigRsp,   /* packing for tightly coupled */
   packDuMacUeReconfigRsp,       /* packing for light weight loosly coupled */
};
/*******************************************************************
 *
...
uint8_t sendAddUeCreateReqToSch(MacUeCfg *ueCfg)
{
   ...
   {
      memset(&schUeCfg.lcCfgToAddList[idx], 0, sizeof(SchLcCfg));
 ...
 *
 * ****************************************************************/
uint8_t createUeCb(Pst *pst, MacUeCfg *ueCfg)
{
   uint8_t ret = ROK;
