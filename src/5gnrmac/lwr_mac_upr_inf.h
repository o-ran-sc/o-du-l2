...
#define MAX_UCI_BIT_PER_TTI_IN_BYTES 1
...
#define UCI_IND_PUCCH_F0F1   1   /* UCI Indicatio carried on PUCCH Format 0, 1 */
#define UCI_IND_PUCCH_F2F3F4 2   /* UCI Indicatio carried on PUCCH Format 2, 3, 4 */
...
typedef struct
{
   ...
   SlotIndInfo   timingInfo;
   uint16_t      numUcis;
   UciIndPduInfo pdus[MAX_ULCCH_PDUS_PER_TTI];
}UciInd;
