...
BsrInfo *bsrInfo)
{
   if(ulDciPtr != NULLP)
   {
      ...
      coreset1Size = bsrPdcchInfo->coreset1Cfg.coreSetSize;
   ...
   RntiType rntiType, uint8_t coreSetType)
{
   if(ulDciReqPdu != NULLP)
   {
	 ...
	 return RFAILED;
      ...
      ulDciReqPdu->pdcchPduConfig.cceRegMappingType = pdcchInfo->coreset1Cfg.cceRegMappingType;
      ulDciReqPdu->pdcchPduConfig.regBundleSize     = pdcchInfo->coreset1Cfg.regBundleSize;
      ulDciReqPdu->pdcchPduConfig.interleaverSize   = pdcchInfo->coreset1Cfg.interleaverSize;
      ulDciReqPdu->pdcchPduConfig.coreSetSize       = pdcchInfo->coreset1Cfg.coreSetType;
      ulDciReqPdu->pdcchPduConfig.shiftIndex        = pdcchInfo->coreset1Cfg.shiftIndex;
      ulDciReqPdu->pdcchPduConfig.precoderGranularity = pdcchInfo->coreset1Cfg.precoderGranularity;
