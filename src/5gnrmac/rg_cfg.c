...
#endif
{
   ...
   {
      memset((U8 *)&cell->ulSf[idx], 0, sizeof(RgUlSf));
   }
...
#endif
{
  ...
  /* Fetch the Active cell */
   ...
   memcpy((U8 *)ueSCellCb.ulLcInfo, (U8 *)ue->ul.lcCb, sizeof(ue->ul.lcCb));
   memcpy((U8 *)ueSCellCb.dlLcInfo, (U8 *)ue->dl.lcCb, sizeof(ue->dl.lcCb));
   for (idx =0; idx < RG_MAX_LCG_PER_UE; idx++)
   {
