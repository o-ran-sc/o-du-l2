   ...
   while((pduLen > 0) && (padding == false))
   {
      ...
      switch(lcId)
      {
         case MAC_UL_LCID_CCCH1:
         {
            ...
            MAC_ALLOC_SHRABL_BUF(ulCcchPdu, length);
            if(!ulCcchPdu)
            {
            ...
            idx++;
            memcpy(ulCcchPdu, &rxDataPdu[idx], length);
            pduLen -= length;
            idx = idx + length;
         ...
         case MAC_UL_LCID_MIN ... MAC_UL_LCID_MAX :
            break;

         case MAC_UL_LCID_RESERVED_MIN ... MAC_UL_LCID_RESERVED_MAX :
            break;

         case MAC_UL_LCID_CCCH :
            break;

         case MAC_UL_LCID_BIT_RATE_QUERY :
            break;

         case MAC_UL_LCID_MULT_PHR_FOUR_OCT :
            break;

         case MAC_UL_LCID_CFG_GRANT_CFM :
            break;

         case MAC_UL_LCID_MULT_PHR_ONE_OCT:
            break;

         case MAC_UL_LCID_SINGLE_PHR :
            break;

         case MAC_UL_LCID_CRNTI :
            break;

         case MAC_UL_LCID_SHIRT_TRUNC_BSR :
            break;

         case MAC_UL_LCID_LONG_TRUNC_BSR :
            break;

         case MAC_UL_LCID_SHORT_BSR :
            break;

         case MAC_UL_LCID_LONG_BSR :
            break;
         
         case MAC_UL_LCID_PADDING :
         {
            padding = true;
            break;
         }
