...
S16 PtUiRguBndCfm ARGS((Pst* pst, SuId suId, U8 status));
 ...
 * request for the interface saps */
S16 PtUiCrgBndCfm ARGS((Pst* pst, SuId suId, U8 status));
/** @brief Configuration Confirm from MAC to RRC */
S16 PtUiCrgCfgCfm ARGS((Pst* pst, SuId suId, CrgCfgTransId transId, U8 status));
#endif /*--#ifdef PTRGUICRG--*/

#ifdef PTRGUIRGR
/** @brief Confirmation from MAC to RRM for the bind/Unbind 
 * request for the interface saps */
S16 PtUiRgrBndCfm ARGS((Pst* pst, SuId suId, U8 status));
/** @brief Configuration Confirm from MAC to RRM */
S16 PtUiRgrCfgCfm ARGS((Pst* pst, SuId suId, RgrCfgTransId transId, U8 status));
S16 PtUiRgrTtiInd ARGS((Pst* pst, SuId suId, RgrTtiIndInfo *ttiInd));
/* Added for SI Enhancement*/
#ifdef RGR_SI_SCH
S16 PtUiRgrSiCfgCfm ARGS((Pst* pst, SuId suId, RgrCfgTransId transId, U8 status));
...
static CONSTANT RgrTtiInd RgUiRgrTtiIndMt[RG_MAX_RGR_USR] =
{
#ifdef LCRGUIRGR
   cmPkRgrTtiInd,
#else
...
/** @brief Confirmation from MAC to RRM for the bind/Unbind 
 * request for the interface saps */
static CONSTANT RgrBndCfm RgUiRgrBndCfmMt[RG_MAX_RGR_USR] =
{
#ifdef LCRGUIRGR
   cmPkRgrBndCfm,
#else
...
static CONSTANT RgmBndCfm RgUiRgmBndCfmMt[RG_MAX_RGM_USR] =
{
#ifdef RGM_LC
   cmPkRgmBndCfm,
#else
...
/** @brief Configuration Confirm from MAC to RRM */
static CONSTANT RgrCfgCfm RgUiRgrCfgCfmMt[RG_MAX_RGR_USR] =
{
#ifdef LCRGUIRGR
   cmPkRgrCfgCfm,
#else
...
static CONSTANT RgrSiCfgCfm RgUiRgrSiCfgCfmMt[RG_MAX_RGR_USR] =
{
#ifdef LCRGUIRGR
   cmPkRgrSiCfgCfm,
#else
...
static CONSTANT RgrWarningSiCfgCfm RgUiRgrWarningSiCfgCfmMt[RG_MAX_RGR_USR] =
{
#ifdef LCRGUIRGR
...
/** @brief Confirmation from MAC to RRC for the bind/Unbind 
 * request for the interface saps */
static CONSTANT CrgBndCfm RgUiCrgBndCfmMt[RG_MAX_CRG_USR] =
{
#ifdef LCRGUICRG
   cmPkCrgBndCfm,
#else
...
/** @brief Configuration Confirm from MAC to RRC */
static CONSTANT CrgCfgCfm RgUiCrgCfgCfmMt[RG_MAX_CRG_USR] =
{
#ifdef LCRGUICRG
   cmPkCrgCfgCfm,
#else
...
/** @brief Confirmation from MAC to RLC for the bind/Unbind 
 * request for the interface saps */
static CONSTANT RguBndCfm RgUiRguBndCfmMt[RG_MAX_RGU_USR] =
{
#ifdef LCRGUIRGU
   cmPkRguBndCfm,
#else
...
/** @brief Data Indication from MAC to RLC to 
 * forward the data received for common channels*/
static CONSTANT RguCDatInd RgUiRguCDatIndMt[RG_MAX_RGU_USR] =
{
#ifdef LCRGUIRGU
...
/** @brief Data Indication from MAC to RLC to 
 * forward the data received for dedicated channels*/
static CONSTANT RguDDatInd RgUiRguDDatIndMt[RG_MAX_RGU_USR] =
{
#ifdef LCRGUIRGU
 ...
 * Informs RLC of the totalBufferSize and Timing Info 
 * for the transmission on common channels. */
static CONSTANT RguCStaInd RgUiRguCStaIndMt[RG_MAX_RGU_USR] =
{
#ifdef LCRGUIRGU
 ...
 * Informs RLC of the totalBufferSize and Timing Info 
 * for the transmission on dedicated channels. */
static CONSTANT RguDStaInd RgUiRguDStaIndMt[RG_MAX_RGU_USR] =
{
#ifdef LCRGUIRGU
...
static CONSTANT RguHqStaInd RgUiRguHqStaIndMt[RG_MAX_RGU_USR] =
{
#ifdef LCRGUIRGU
   cmPkRguHqStaInd,
#else
...
#ifdef RGR_CQI_REPT
/** @brief TTI indication from MAC to RRM */
static CONSTANT RgrStaInd RgUiRgrStaIndMt[RG_MAX_RGR_USR] =
{
#ifdef LCRGUIRGR
   cmPkRgrStaInd,
#else
...
static CONSTANT RgrLoadInfInd RgUiRgrLoadInfIndMt[RG_MAX_RGR_USR] =
{
#ifdef LCRGUIRGR
   cmPkRgrLoadInfInd,
#else
...
/** @brief TTI indication from MAC to RRM */
static CONSTANT RgrUeStaInd RgUiRgrUeStaIndMt[RG_MAX_RGR_USR] =
{
#ifdef LCRGUIRGR
   cmPkRgrUeStaInd,
#else
...
static CONSTANT RgmPrbRprtIndFptr RgUiRgmSendPrbRprtIndMt[RG_MAX_RGM_USR] =
{
#ifdef RGM_LC
   cmPkRgmPrbRprtInd,
#else
...
static CONSTANT RgmTransModeIndFptr RgUiRgmChangeTransModeIndMt[RG_MAX_RGM_USR] =
{
#ifdef RGM_LC
   cmPkRgmTransModeInd,
#else
...
static CONSTANT RguFlowCntrlIndInfo RgUiRguFlowCntrlIndMt[RG_MAX_RGU_USR] =
{
#ifdef LCRGUIRGU
   cmPkRguFlowCntrlInd,
#else
