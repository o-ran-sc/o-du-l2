...
//   RgInfSpsRelInfo   relInfo;
   ...
   */
   ...
   if(pdu->sduLst.first)
   {
      ...
      memset((U8 *)dDatInd, 0x00, sizeof(RgRguDedDatInd));
#endif
   ...
   if(isSpsRnti && dDatInd && dDatInd->numLch)
   {
      ...
      else
      {
         ...
         if (ueCb->ul.explRelCntr == ueCb->ul.explRelCnt)
         {
            ...
            memset((U8*)&schPst1, (U8)0, sizeof(Pst));
...
#endif
{
  ...
  // RgInfSpsRelInfo   relInfo;
   ...
   memset((U8 *)&lcgBytes, 0, sizeof(lcgBytes));
