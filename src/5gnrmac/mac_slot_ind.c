 ...
 * @details
 *
 *     Function : buildAndSendMsg4MuxPdu
 * 
 ...
 *  @return  void
 **/
void fillMsg4MuxPdu(Msg4Alloc *msg4Alloc)
{
...
/**
 * @brief Builds and Send the Msg4 Muxed Pdu to Lower MAC
 *
 * @details
 *
 *     Function : buildAndSendMsg4MuxPdu
 * 
 *      Build and Sends the Msg4 Muxed Pdu to Lower MAC.
 *           
 *  @param[in]  SlotIndInfo    *slotInd
 *  @return  void
 **/

void buildAndSendMsg4MuxPdu(SlotIndInfo currTimingInfo)
{
   MacDlSlot *currDlSlot = NULLP;
   ...
   if(currDlSlot->dlInfo.msg4Alloc)
	{
      fillMsg4MuxPdu(currDlSlot->dlInfo.msg4Alloc);
		currDlSlot = NULLP;
   }
}
