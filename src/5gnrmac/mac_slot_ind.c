            ...
            for(schInfoIdx=0; schInfoIdx < dlSchedInfo->dlMsgAlloc[ueIdx]->numSchedInfo; schInfoIdx++)
            {
               if(dlSchedInfo->dlMsgAlloc[ueIdx]->dlMsgSchedInfo[schInfoIdx].dlMsgInfo.isMsg4Pdu)
               {
                  ...
                  if(!dlSchedInfo->dlMsgAlloc[ueIdx]->dlMsgSchedInfo[schInfoIdx].isRetx)
                  {
                     ...
                     DU_LOG("\nHLAL ADDED HQ Proc Id [%d] [SFN:SLOT] [%d]:%d] NumTb [%d] TbSz1 [%d] Tb1 [%x] TbSz2 [%d] Tb2 [%x]", \
                           hqProcCb->procId, dlSchedInfo->schSlotValue.dlMsgTime.sfn, dlSchedInfo->schSlotValue.dlMsgTime.slot, \
                           hqProcCb->numTb, hqProcCb->tbInfo[0].tbSize, hqProcCb->tbInfo[0].tb, \
                           hqProcCb->tbInfo[1].tbSize, hqProcCb->tbInfo[1].tb);
                  ...
                  else
                  {
                     ...
                     DU_LOG("\nHLAL MSG4 Re-Tx Time Updated HQ Proc Id [%d] NumTb [%d] TbSz1 [%d] Tb1 [%x] TbSz2 [%d] Tb2 [%x]", \
                           hqProcCb->procId, hqProcCb->numTb, hqProcCb->tbInfo[0].tbSize, hqProcCb->tbInfo[0].tb, \
                           hqProcCb->tbInfo[1].tbSize, hqProcCb->tbInfo[1].tb);
                  }
               }
               else
               {
                  ...
                  if(!dlSchedInfo->dlMsgAlloc[ueIdx]->dlMsgSchedInfo[schInfoIdx].isRetx)
                  {
                           ...
                           (dlSchedInfo->dlMsgAlloc[ueIdx]->dlMsgSchedInfo[schInfoIdx].pduPres == BOTH))
                     {
                        ...
                        macCb.macCell[cellIdx]->ueCb[ueIdx].dlInfo.dlHarqEnt.harqProcCb[dlSchedInfo->dlMsgAlloc[ueIdx]\
                        ->dlMsgSchedInfo[schInfoIdx].dlMsgInfo.harqProcNum].procId,
                        macCb.macCell[cellIdx]->ueCb[ueIdx].dlInfo.dlHarqEnt.harqProcCb[dlSchedInfo->dlMsgAlloc[ueIdx]\
                        ->dlMsgSchedInfo[schInfoIdx].dlMsgInfo.harqProcNum].numTb,
                        macCb.macCell[cellIdx]->ueCb[ueIdx].dlInfo.dlHarqEnt.harqProcCb[dlSchedInfo->dlMsgAlloc[ueIdx]\
                        ->dlMsgSchedInfo[schInfoIdx].dlMsgInfo.harqProcNum].tbInfo[0].txTime.sfn,
                        macCb.macCell[cellIdx]->ueCb[ueIdx].dlInfo.dlHarqEnt.harqProcCb[dlSchedInfo->dlMsgAlloc[ueIdx]\
                        ->dlMsgSchedInfo[schInfoIdx].dlMsgInfo.harqProcNum].tbInfo[0].txTime.slot,
                        macCb.macCell[cellIdx]->ueCb[ueIdx].dlInfo.dlHarqEnt.harqProcCb[dlSchedInfo->dlMsgAlloc[ueIdx]\
                        ->dlMsgSchedInfo[schInfoIdx].dlMsgInfo.harqProcNum].tbInfo[0].tbSize);
                     }
                  }
                  else
                  {
...
void fillMsg4Pdu(uint16_t cellId, DlMsgSchInfo *msg4SchInfo)
{
   ...
   if(macCb.macCell[cellIdx]->macRaCb[ueIdx].msg4Pdu != NULLP)
   {
      ...
      {
         msg4TxPduLen = macCb.macCell[cellIdx]->macRaCb[ueIdx].msg4HqInfo.tbInfo[0].tbSize - TX_PAYLOAD_HDR_LEN;
         ...
         /* Forming Mux Pdu */
         macCb.macCell[cellIdx]->macRaCb[ueIdx].msg4HqInfo.tbInfo[0].tb = NULLP;
         MAC_ALLOC(macCb.macCell[cellIdx]->macRaCb[ueIdx].msg4HqInfo.tbInfo[0].tb, msg4TxPduLen);
         if(macCb.macCell[cellIdx]->macRaCb[ueIdx].msg4HqInfo.tbInfo[0].tb != NULLP)
         {
            memset(macCb.macCell[cellIdx]->macRaCb[ueIdx].msg4HqInfo.tbInfo[0].tb, 0, msg4TxPduLen);
            macMuxPdu(&msg4DlData, &macCeData, macCb.macCell[cellIdx]->macRaCb[ueIdx].msg4HqInfo.tbInfo[0].tb, msg4TxPduLen);
         }
         else
         {
         ...
         hqProcCb = &macCb.macCell[cellIdx]->macRaCb[ueIdx].msg4HqInfo;
         DU_LOG("\nHLAL Updated HQ Proc Id [%d] [SFN:SLOT] [%d:%d] NumTb [%d] TbSz1 [%d] Tb1 [%x] TbSz2 [%d] Tb2 [%x]", \
               hqProcCb->procId, hqProcCb->tbInfo[0].txTime.sfn, hqProcCb->tbInfo[0].txTime.slot, \
               hqProcCb->numTb, hqProcCb->tbInfo[0].tbSize, hqProcCb->tbInfo[0].tb, \
               hqProcCb->tbInfo[1].tbSize, hqProcCb->tbInfo[1].tb);
      }
   }
   ...
   if(macCb.macCell[cellIdx]->macRaCb[ueIdx].msg4HqInfo.tbInfo[0].tb)
   {
      ...
      {
         memcpy(msg4SchInfo->dlMsgInfo.dlMsgPdu, macCb.macCell[cellIdx]->macRaCb[ueIdx].msg4HqInfo.tbInfo[0].tb, \
               msg4SchInfo->dlMsgInfo.dlMsgPduLen);
      }

      hqProcCb = &macCb.macCell[cellIdx]->macRaCb[ueIdx].msg4HqInfo;
      DU_LOG("\nHLAL FETCHED HQ Proc Id [%d] [SFN:SLOT] [%d:%d] NumTb [%d] TbSz1 [%d] Tb1 [%x] TbSz2 [%d] Tb2 [%x]", \
            hqProcCb->procId, hqProcCb->tbInfo[0].txTime.sfn, hqProcCb->tbInfo[0].txTime.slot, \
            hqProcCb->numTb, hqProcCb->tbInfo[0].tbSize, hqProcCb->tbInfo[0].tb, \
            hqProcCb->tbInfo[1].tbSize, hqProcCb->tbInfo[1].tb);
   }
