 ...
 *      -# RFAILED 
 **/
static S16 rgDUXExtCe(Inst inst,RgMacPdu *pdu,RgInfCeInfo *ceInfo,Buffer *mBuf,uint8_t lcId,uint16_t subPduLen,RgErrInfo *err)
{
   S16            ret;
 ...
 *      -# RFAILED 
 **/
static S16 rgDUXExtSdu(Inst inst,RgMacPdu *pdu,RgInfCeInfo *ceInfo,Buffer **mBuf,uint8_t lcId,uint16_t subPduLen,RgErrInfo *err)
{
   S16         ret;
   Buffer      *tmpBuf1;
