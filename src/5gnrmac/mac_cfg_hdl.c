 ...
 *     [Step 1]-
 *       If schStatsDeleteRsp is available, 
 ...
 *     [Step 3]-If numStatsGroup is greater than 0 then fill
 *       each rsp and cause of each statsGrpInfo
 *     [Step 4]-If numStatsGroup is not greater than 0 then fill
 *       cmpltStatsDelrsp and cmpltStatsDelcause
 *
...
uint8_t MacSendStatsDeleteRspToDuApp(SchStatsDeleteRsp *schStatsDeleteRsp,  MacStatsDeleteReq *macStatsDeleteReq)
{
   ...
   if(schStatsDeleteRsp)
   {
      ...
      /* if numStatsGroup is greater than 0 then fill the response statsGrpInfo
       * array else we will fill the complete ric subs delete rsp and cause */
      if(macStatsDeleteRsp->numStatsGroup)
      {
         /* filling rsp for each statsGrpInfo individually */
      ...
      {
         /* fill the information in case of complete ric sub deletion scenario */
