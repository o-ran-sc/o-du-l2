...
uint8_t MacSchCellCfgReq(Pst *pst, MacCellCfg *macCellCfg)
{
   ...
   schCellCfg.bandwidth = macCellCfg->carrCfg.dlBw;
   ...
   schCellCfg.sib1SchCfg.coresetZeroIndex = macCellCfg->sib1Cfg.pdcchCfgSib1.coresetZeroIndex;
   schCellCfg.sib1SchCfg.searchSpaceZeroIndex = macCellCfg->sib1Cfg.pdcchCfgSib1.searchSpaceZeroIndex;
