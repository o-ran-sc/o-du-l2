...
/**
 * @brief fill the paging response and send it to DUAPP 
 *
 * @details
 *
 *     Function : fillAndSendPagingRspToDu
 *
 *     fill the paging response and send it to DUAPP
 *
 *  @param[in] uint16_t cellId, uint8_t result 
 *  @return -# RFAILED 
 *      -# ROK
 **/
      ...
      else
      {
         ...
         else
         {
            ...
            else
            {
               ...
               FILL_PST_MAC_TO_SCH(schPst, EVENT_PAGING_REQ_TO_SCH);
