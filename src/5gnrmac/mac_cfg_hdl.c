...
uint8_t MacSchCellCfgReq(Pst *pst, MacCellCfg *macCellCfg)
{
   ...
   schCellCfg.dlFreq = macCellCfg->carrCfg.dlFreq;
   schCellCfg.ulFreq = macCellCfg->carrCfg.ulFreq;
   ...
   schCellCfg.dlCfgCommon.pcchCfg.numPO  =  macCellCfg->sib1Cfg.pagingCfg.numPO;
   schCellCfg.dlCfgCommon.pcchCfg.poPresent = macCellCfg->sib1Cfg.pagingCfg.poPresent;

   if(schCellCfg.dlCfgCommon.pcchCfg.poPresent)
   {
      memcpy(schCellCfg.dlCfgCommon.pcchCfg.pagingOcc, macCellCfg->sib1Cfg.pagingCfg.pagingOcc, MAX_PO_PER_PF);
   }
   ...
   if(macCellCfg->cellCfg.plmnInfoList.snssai) 
   {
