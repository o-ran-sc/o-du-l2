...
uint8_t MacProcCellCfgReq(Pst *pst, MacCellCfg *macCellCfg)
{
   ...
   memcpy(&macCb.macCell->macCellCfg,macCellCfg,sizeof(MacCellCfg));
   MAC_ALLOC(macCb.macCell->macCellCfg.sib1Cfg.sib1Pdu, \
      macCb.macCell->macCellCfg.sib1Cfg.sib1PduLen);
   memcpy(macCb.macCell->macCellCfg.sib1Cfg.sib1Pdu, macCellCfg->sib1Cfg.sib1Pdu, \
      macCb.macCell->macCellCfg.sib1Cfg.sib1PduLen);
   ...
   if(ret != ROK)
   {
      ...
      /* Fill Pst */
      FILL_PST_TO_DUAPP(cfmPst, EVENT_MAC_CELL_CONFIG_CFM);
...
uint8_t MacSchCellCfgReq(Pst *pst, MacCellCfg *macCellCfg)
{
   ...
   FILL_PST_TO_SCH(cfgPst, EVENT_SCH_CELL_CFG);
...
void MacSendCellCfgCfm(uint8_t response)
{
   ...
   macCellCfgCfm.transId = macCb.macCell->macCellCfg.transId;
   macCellCfgCfm.rsp = response;

   /* Fill Pst */
   FILL_PST_TO_DUAPP(pst, EVENT_MAC_CELL_CONFIG_CFM);
   pst.selector  = ODU_SELECTOR_LC;
 ...
 *      -# ROK
 **/
int MacProcSchCellCfgCfm(Pst *pst, SchCellCfgCfm *schCellCfgCfm)
{
