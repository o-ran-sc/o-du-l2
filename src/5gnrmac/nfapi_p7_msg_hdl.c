...
uint8_t nfapiBuildAndSendDlNodeSync()
{
   ...
   DU_LOG("\n SANGEETA : UDP : DL_NODE_SYNC: sfn/slot:%d,%d, t1:%u", vnfDb.vnfP7Info.p7SyncInfo.frameInfo.sfn, \
           vnfDb.vnfP7Info.p7SyncInfo.frameInfo.slot, t1);
   ...
   CMCHKPK(oduPackPostUInt32, vnfDb.vnfP7Info.p7SyncInfo.delta_sfn_slot, mBuf);
