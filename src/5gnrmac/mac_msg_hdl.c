 ...
 *
 *    Functionality:
 *      Handles cell start reuqest from MAC
 *
 ...
 *
 * ****************************************************************/
S16 MacHdlCellStartReq(Pst *pst, MacCellStartInfo  *cellStartInfo)
{
 ...
 *
 * ****************************************************************/
S16 MacHdlCellStopReq(Pst *pst, MacCellStopInfo  *cellStopInfo)
{
   DU_LOG("\nMAC : Handling cell start request");
