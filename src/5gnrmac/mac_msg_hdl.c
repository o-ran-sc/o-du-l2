 ...
 *
 * ****************************************************************/
uint16_t MacProcCellStartReq(Pst *pst, MacCellStartInfo  *cellStartInfo)
{
 ...
 *
 * ****************************************************************/
uint16_t MacProcCellStopReq(Pst *pst, MacCellStopInfo  *cellStopInfo)
{
#ifdef INTEL_FAPI
 ...
 *
 * ****************************************************************/
uint16_t MacProcDlCcchInd(Pst *pst, DlCcchIndInfo *dlCcchIndInfo)
{
   uint16_t idx;
