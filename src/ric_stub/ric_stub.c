...
void readRicCfg()
{
   ...
   ricCb.ricCfgParams.sctpParams.sctpAssoc[0].duIpAddr.ipV4Addr = ipv4_du;
   ricCb.ricCfgParams.sctpParams.sctpAssoc[0].duIpAddr.ipV6Pres = false;
   ricCb.ricCfgParams.sctpParams.sctpAssoc[0].duPort = g_cfg.RIC_Port;

   ricCb.ricCfgParams.sctpParams.sctpAssoc[0].ricIpAddr.ipV4Addr = ipv4_ric;
   ricCb.ricCfgParams.sctpParams.sctpAssoc[0].ricIpAddr.ipV6Pres = false;
   ricCb.ricCfgParams.sctpParams.sctpAssoc[0].ricPort = g_cfg.RIC_Port;

   ricCb.ricCfgParams.sctpParams.numDu = 1;
