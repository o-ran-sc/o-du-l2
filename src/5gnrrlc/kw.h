...
#define RLC_MEM_CPY(_dst, _src, _size)  memcpy((U8*)_dst, (U8 *)_src, _size); 

#define RLC_MEM_ZERO(_buf, _size) memset((U8 *)(_buf), 0, _size);
...
/* Memset to value */
#define RLC_MEM_SET(_arg, _val, _size) memset((U8 *)_arg, (U8)_val, _size); 
...
{                                                             \
   S8 _buf[60];                                               \
   DateTime dt;                                               \
   memset((U8 *)(&dt), 0, sizeof(DateTime));                \
   SGetDateTime(&dt);                                         \
