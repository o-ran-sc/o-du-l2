...
/* Timer events */
#define RLC_EVNT_UMUL_REASSEMBLE_TMR     1
#define RLC_EVNT_AMUL_REORD_TMR          2
#define RLC_EVNT_AMUL_STA_PROH_TMR       3
#define RLC_EVNT_AMDL_POLL_RETX_TMR      4
#define RLC_EVNT_WAIT_BNDCFM             5
/* kw005.201 added support for L2 Measurement */
#ifdef LTE_L2_MEAS
#define RLC_EVNT_L2_TMR                  6
#endif /* LTE_L2_MEAS */
