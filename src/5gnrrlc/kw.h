...
#define KWDBGP_ERROR(_cb, ...) \
   KWDBGP_INTERNAL(_cb,(RLC_DBGMASK_ERROR | RLC_MODULE),__VA_ARGS__)

#define KWDBGP_DETAIL(_cb, ...) \
   KWDBGP_INTERNAL(_cb,(RLC_DBGMASK_DETAIL | RLC_MODULE),__VA_ARGS__)

#define KWDBGP_BRIEF(_cb, ...) \
   KWDBGP_INTERNAL(_cb,(RLC_DBGMASK_BRIEF | RLC_MODULE),__VA_ARGS__)   
