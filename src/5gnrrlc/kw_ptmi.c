...
PRIVATE S16 PtMiLrlcCfgCfm    ARGS((Pst *pst, KwMngmt *cfm));
...
PRIVATE LrlcCfgCfm kwMiLrlcCfgCfmMt[MAXKWMI] =
{
#ifdef LCKWMILKW
   cmPkLrlcCfgCfm,            /* 0 - loosely coupled - fc */
#else
   PtMiLrlcCfgCfm,            /* 0 - tightly coupled portable */
#endif /* LCRLMILKW */
#ifdef SM
   SmMiLrlcCfgCfm,            /* 1 - tightly coupled layer management*/
#else
   PtMiLrlcCfgCfm,            /* 1 - tightly coupled portable */
#endif /* SM */
};
...
/**
   @brief
   This function is called by the KwMiLrlcCfgReq function for responding
...
*/
#ifdef ANSI
PUBLIC S16 KwMiLrlcCfgCfm
(
Pst        *pst,                /* post structure */
KwMngmt    *cfm                 /* Layer Management structure */
)
#else
PUBLIC S16 KwMiLrlcCfgCfm(pst, cfm)
Pst        *pst;                /* post structure */
KwMngmt    *cfm;                /* Layer Management structure */
#endif
{
   ...
   (*kwMiLrlcCfgCfmMt[pst->selector])(pst, cfm);
...
#ifdef ANSI
PUBLIC S16 PtMiLrlcCfgCfm
(
Pst *pst,                    /* post structure */
KwMngmt *cfm                 /* Layer Management structure */
)
#else
PUBLIC S16 PtMiLrlcCfgCfm(pst, cfm)
Pst *pst;                    /* post structure */
KwMngmt *cfm;                /* Layer Management structure */
#endif
{
   ...
   TRC2(PtMiLrlcCfgCfm() : function is not implemented)

   RETVALUE(ROK);
} /* end of PtMiLrlcCfgCfm */
