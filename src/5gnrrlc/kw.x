...
typedef struct rlcL2Cb
{
   ...
   RlcL2MeasEvtCb  kwL2EvtCb[LKW_MAX_L2MEAS];  /*!< Pointers to Measurement Cb */
...
#ifdef LTE_L2_MEAS
   RlcL2Cb              kwL2Cb; /*!< Control Block for L2 Measurements in RLC */
#endif /* LTE_L2_MEAS */
}RlcDlCb;
...
typedef struct rlcCb
{
   ...
   CmTqType   kwTq[RLC_TMR_LEN];   /*!< Timer queue */
