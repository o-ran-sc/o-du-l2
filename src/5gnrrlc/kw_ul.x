...
#ifdef LTE_L2_MEAS
EXTERN S16 rlcUtlHdlL2TmrExp   ARGS (( RlcCb *gCb, KwL2MeasEvtCb *measEvtCb));
...
EXTERN S16 rlcUtlSndUlL2MeasCfm  ARGS ((RlcCb *gCb, KwL2MeasEvtCb *measEvtCb));
...
EXTERN Void rlcUtlResetUlL2MeasInKwRb ARGS((RlcCb *gCb,
                                           KwL2MeasCb *measCb,
                                           U8 measType));
