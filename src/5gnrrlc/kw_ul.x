...
EXTERN S16 kwValidateRbCfgParams ARGS ((RlcCb *gCb,
                                        ...
                                        CmStatus        *status));
EXTERN S16 kwCfgValidateUlRb ARGS (( RlcCb *gCb,
                                    CkwEntCfgInfo *cfgToValidate,
                                    RlcUlEntTmpData *cfgInfo, 
                                    RlcUlCfgTmpData *cfg));

EXTERN S16 kwCfgRollBackUlRb ARGS ((RlcCb *gCb,
                                    CmLteRnti ueId,
                                    CkwEntCfgInfo *cfgToValidate,
                                    RlcUlEntTmpData *cfgTempData));

EXTERN Void kwCfgApplyUlRb ARGS ((RlcCb *gCb,
                                  CkwEntCfgInfo *cfgToAply,
                                  RlcUlEntTmpData *cfgTmpData,
                                  RlcUlCfgTmpData *cfgTmpInfo));

EXTERN S16 kwCfgValidateReEstRb ARGS ((RlcCb *gCb,
                                       CmLteRnti  ueId,
                                       CmLteCellId cellId,
                                       CkwEntCfgInfo *cfgToValidate,
                                       RlcUlEntTmpData   *cfgTmpData));

EXTERN Void kwCfgApplyReEstUlRb ARGS ((RlcCb *gCb,
                                      CmLteRnti ueId,
                                      CmLteCellId cellId,
                                      Bool sndReEstInd,
                                      RlcUlEntTmpData *cfgTmpData));

EXTERN Void kwCfgApplyDelUlCell ARGS ((RlcCb *gCb,
                                      RlcUlCfgTmpData *cfgTmpData));

EXTERN S16 kwCfgValidateDelUlCell ARGS ((RlcCb *gCb,
                                         CmLteCellId cellId,
                                         CkwEntCfgInfo *cfgToValidate,
                                         RlcUlEntTmpData   *cfgTmpData,
                                         RlcUlCfgTmpData *cfgInfo));

EXTERN S16 kwCfgValidateDelUlUe ARGS ((RlcCb *gCb,
                                       CkwEntCfgInfo *cfgToValidate,
                                       RlcUlEntTmpData *cfgTmpData,
                                       RlcUlCfgTmpData *cfgInfo));

EXTERN Void kwCfgApplyDelUlUe ARGS ((RlcCb *gCb,
                                    RlcUlCfgTmpData *cfgTmpData));
...
EXTERN Void kwCfgApplyUlUeIdChng ARGS ((RlcCb *gCb,
                                        CkwUeInfo *ueInfo,
                                        CkwUeInfo *newUeInfo,
                                        RlcUlCfgTmpData *cfgTmpInfo));

EXTERN S16 kwCfgValidateUeIdChng ARGS ((RlcCb *gCb,
                                        CkwUeInfo *ueInfo,
                                        CkwUeInfo *newUeInfo,
                                        RlcUlCfgTmpData *cfgTmpInfo));
