...
Void ResetRLCStats(Void)
{
   ...
   memset((U8*)&gRlcStats, 0, sizeof(RLCStats));
   memset((U8*)&dlInst->genSts,0,sizeof(RlcGenSts));
   memset((U8*)&ulInst->genSts,0,sizeof(RlcGenSts));
}
...
S16 rlcUtlL2MeasDlInit(RlcCb *gCb)
{
   ...
   {
      memset((U8 *)&(gCb->u.dlCb->rlcL2Cb.rlcL2EvtCb[cntr]), 0, sizeof(RlcL2MeasEvtCb));
   }
