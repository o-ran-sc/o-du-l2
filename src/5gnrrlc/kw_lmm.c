...
/**
 * @brief
 *     Sends confirmation message to LM Called by KwMiLrlcCfgReq function
 * 
 * @param[in] gCb    RLC Instance Control Block
...
#ifdef ANSI
PUBLIC S16 KwMiLrlcCfgReq 
(
Pst       *pst, 
KwMngmt   *cfg
)
#else
PUBLIC S16 KwMiLrlcCfgReq (pst, cfg)
Pst       *pst;
KwMngmt   *cfg;
#endif
{
   ...
   RLOG1(L_DEBUG, "KwMiLrlcCfgReq elmId(%d)", cfg->hdr.elmId.elmnt);
