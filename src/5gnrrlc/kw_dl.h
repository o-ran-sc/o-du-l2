...
{                                                                              \
   if(((_rlcRbCb)->rlcId.rbType == CM_LTE_DRB) &&                               \
      ((_rlcCb)->u.dlCb->kwL2Cb.measOn[_rlcRbCb->qci] & LKW_L2MEAS_DL_DELAY))    \
   {                                                                           \
...
{                                                                 \
   if(((_rlcRbCb)->rlcId.rbType == CM_LTE_DRB) &&                              \
      ((_rlcCb)->u.dlCb->kwL2Cb.measOn[_rlcRbCb->qci] & LKW_L2MEAS_UU_LOSS))              \
   {                                                              \
...
{                                                                 \
   if(((_rlcRbCb)->rlcId.rbType == CM_LTE_DRB) &&                              \
      ((_rlcCb)->u.dlCb->kwL2Cb.measOn[_rlcRbCb->qci] & LKW_L2MEAS_DL_DISC))              \
   {                                                              \
...
{                                                                 \
   ...
   {                                                              \
      ...
      {                                                           \
         ...
         {                                                        \
            if(_rlcCb->u.dlCb->kwL2Cb.kwL2EvtCb[idx1].measCb.val.nonIpThMeas.measData[(_rlcRbCb)->qci].totDrbsPerQci > 0) \
            {                                                                                               \
               _rlcCb->u.dlCb->kwL2Cb.kwL2EvtCb[idx1].measCb.val.nonIpThMeas.measData[(_rlcRbCb)->qci].totDrbsPerQci--;   \
               if (_rlcCb->u.dlCb->kwL2Cb.kwL2EvtCb[idx1].measCb.val.nonIpThMeas.measData[(_rlcRbCb)->qci].totDrbsPerQci == 0) \
               {                                                                                                 \
                  _rlcCb->u.dlCb->kwL2Cb.kwL2EvtCb[idx1].measCb.val.nonIpThMeas.qci[(_rlcRbCb)->qci] = 0;                      \
                  cmMemset((U8 *)&_rlcCb->u.dlCb->kwL2Cb.kwL2EvtCb[idx1].measCb.val.nonIpThMeas.measData[(_rlcRbCb)->qci], 0,  \
                     sizeof(_rlcCb->u.dlCb->kwL2Cb.kwL2EvtCb[idx1].measCb.val.nonIpThMeas.measData[(_rlcRbCb)->qci]));            \
               }                                                                                                 \
            }                                                                                                    \
         }                                                                                                       \
      }                                                                                                          \
