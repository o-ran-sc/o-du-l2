...
RlcDuUeReestablishmentRsp rlcUeReestablishmentRspOpts[] =
{
   packRlcDuUeReestablishmentRsp,     /* 0 - loosely coupled */
   DuProcRlcUeReestablishmentRsp,     /* 1 - tightly coupled */
   packRlcDuUeReestablishmentRsp     /* 2 - LWLC loosely coupled */
};
 ...
 * @details
 *
 *    Function : rlcSendUeReestablishmentRspToDu 
 *
 *    Functionality:  Sends Ue Reestablishment Rsp to DU APP
 *
 * @params[in] Pst *pst, RlcUeReestablishmentRsp *ueReestablishmentRsp 
 *             
 * @return ROK     - success
 *         RFAILED - failure
 *
 * ****************************************************************/
uint8_t rlcSendUeReestablishmentRspToDu(Pst *pst, RlcUeReestablishmentRsp *ueReestablishmentRsp)
{
    return (*rlcUeReestablishmentRspOpts[pst->selector])(pst, ueReestablishmentRsp);
}
