...
SRC_DIR=$(ROOT_DIR)/src/5gnrmac/IAPI_CL
...
lib: $(LIB_DIR)/libiapicl.a
include $(COM_BUILD_DIR)/compile.mak

I_OPTS+=-I$(ROOT_DIR)/src/mt
I_OPTS+=-I$(ROOT_DIR)/src/5gnrmac
I_OPTS+=-I$(ROOT_DIR)/src/5gnrmac/IAPI_CL
...
#Linker macros
#-------------------------------------------------------------#
$(LIB_DIR)/libiapicl.a:$(C_OBJS)
		  @echo -e "Creating Archive $(COLOR) $@ $(REVERT_COLOR)"
		  $(Q)ar -cr $(LIB_DIR)/libiapicl.a $(C_OBJS) 
...
clean:
		  @echo $(OAM_ENABLE)
		  @echo -e "$(COLOR_RED)Cleaning IAPI CL$(REVERT_COLOR)"
		  @echo $(SRC_DIR) $(CM_DIR)
		  $(Q)\rm -f $(LIB_DIR)/libiapicl.a $(C_OBJS) 
