...
BAK_FILES=$(patsubst $(SRC_DIR)/%.cpp,$(OBJ_DIR)/%.i.bak,$(CPP_SRCS))
...
#-------------------------------------------------------------#
clean:
		  @echo -e "$(COLOR_RED)Cleaning O1$(REVERT_COLOR) $(I_OPTS)"
		  $(Q)\rm -f $(LIB_DIR)/libo1.a $(CPP_OBJS) $(LOG_FILES) $(BAK_FILES)
