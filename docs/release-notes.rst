...
|                    |                    |                    |                    |
+--------------------+--------------------+--------------------+--------------------+
| 2023-12-13         | 9.0.0              | Radisys            | I release          |
|                    |                    |                    |                    |
+--------------------+--------------------+--------------------+--------------------+
...
- Current code supports two KPIs related to Radio resource utilization, One DL Total PRB Usage and other one UL Total PRB Usage.

- Multi UE (max=2) scheduling per TTI in scheduler is only supported in the case of DL scheduling.
