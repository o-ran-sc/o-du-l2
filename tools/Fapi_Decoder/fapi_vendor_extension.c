...
void print_fapi_api_queue_elem_t( fapi_api_queue_elem_t* elem) 
{
    if (elem == NULL) {
...
void print_fapi_config_req_vendor_msg_t( fapi_config_req_vendor_msg_t* config_req) 
{
    if (config_req == NULL) {
        printf("Error == Null pointer received.\n");
        return;
...
void print_fapi_start_req_vendor_msg_t( fapi_start_req_vendor_msg_t* start_req) 
{
    if (start_req == NULL) {
        printf("Error == Null pointer received.\n");
        return;
...
void print_fapi_stop_req_vendor_msg_t( fapi_stop_req_vendor_msg_t* stop_req) 
{
    if (stop_req == NULL) {
        printf("Error == Null pointer received.\n");
        return;
...
void print_fapi_vendor_ul_pusch_pdu_t( fapi_vendor_ul_pusch_pdu_t* pusch_pdu) 
{
    if (pusch_pdu == NULL) {
        printf("Error == Null pointer received.\n");
        return;
...
void print_fapi_vendor_ul_pucch_pdu_t( fapi_vendor_ul_pucch_pdu_t* pucch_pdu) 
{
    if (pucch_pdu == NULL) {
        printf("Error == Null pointer received.\n");
        return;
...
void print_fapi_vendor_ul_srs_pdu_t( fapi_vendor_ul_srs_pdu_t* srs_pdu) 
{
    if (srs_pdu == NULL) {
        printf("Error == Null pointer received.\n");
        return;
...
void print_fapi_vendor_ul_tti_req_pdu_t( fapi_vendor_ul_tti_req_pdu_t* ul_tti_req_pdu) 
{
    ...
    switch (ul_tti_req_pdu->pdu_type) 
    {
        case FAPI_PUSCH_PDU_TYPE: 
            printf("pusch_pdu\n");
            print_fapi_vendor_ul_pusch_pdu_t(&ul_tti_req_pdu->pdu.pusch_pdu);
            break;
        case FAPI_PUCCH_PDU_TYPE: 
            printf("pucch_pdu\n");
            print_fapi_vendor_ul_pucch_pdu_t(&ul_tti_req_pdu->pdu.pucch_pdu);
            break;
        case FAPI_SRS_PDU_TYPE: 
            printf("srs_pdu\n");
            print_fapi_vendor_ul_srs_pdu_t(&ul_tti_req_pdu->pdu.srs_pdu);
            break;
        default:
...
void print_fapi_vendor_ul_tti_req_t( fapi_vendor_ul_tti_req_t* ul_tti_req) 
{
    if (ul_tti_req == NULL) 
    {
        printf("Error == Null pointer received.\n");
    ...
    {
        printf("ul_pdus[%d]:\n", i);
        print_fapi_vendor_ul_tti_req_pdu_t(&ul_tti_req->ul_pdus[i]);
    }
    printf("\n");
}


void print_fapi_vendor_dl_dci_t( fapi_vendor_dl_dci_t* dl_dci) 
{
    if (dl_dci == NULL) {
        printf("Error == Null pointer received.\n");
        return;
...
void print_fapi_vendor_dl_pdcch_pdu_t( fapi_vendor_dl_pdcch_pdu_t* dl_pdcch_pdu) {
    ...
    for (int i = 0; i < dl_pdcch_pdu->num_dl_dci; ++i) {
        printf("dl_dci[%d]:\n", i);
        print_fapi_vendor_dl_dci_t(&dl_pdcch_pdu->dl_dci[i]);
    }
    printf("\n");
}

void print_fapi_vendor_dl_pdsch_pdu_t( fapi_vendor_dl_pdsch_pdu_t* pdsch_pdu) {
    if (pdsch_pdu == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
...
void print_fapi_vendor_csi_rs_pdu_t( fapi_vendor_csi_rs_pdu_t* csi_rs_pdu) {
    if (csi_rs_pdu == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
...
void print_fapi_vendor_dl_tti_req_pdu_t( fapi_vendor_dl_tti_req_pdu_t* dl_tti_req_pdu) {
    ...
    switch (dl_tti_req_pdu->pdu_type) 
    {
        case FAPI_PDCCH_PDU_TYPE: 
            printf("pdcch_pdu:\n");
            print_fapi_vendor_dl_pdcch_pdu_t(&dl_tti_req_pdu->pdu.pdcch_pdu);
            break;
        case FAPI_PDSCH_PDU_TYPE: 
            printf("pdsch_pdu:\n");
            print_fapi_vendor_dl_pdsch_pdu_t(&dl_tti_req_pdu->pdu.pdsch_pdu);
            break;
        case FAPI_CSIRS_PDU_TYPE: 
            printf("csi_rs_pdu:\n");
            print_fapi_vendor_csi_rs_pdu_t(&dl_tti_req_pdu->pdu.csi_rs_pdu);
            break;
        default :
            printf("Unknown PDU type\n");
            break;
...
void print_fapi_vendor_dl_tti_req_t( fapi_vendor_dl_tti_req_t* dl_tti_req) {
    if (dl_tti_req == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
    ...
    for (int i = 0; i < dl_tti_req->num_pdus; ++i) {
        printf("pdus[%d]:\t", i);
        print_fapi_vendor_dl_tti_req_pdu_t(&dl_tti_req->pdus[i]);
    }
    printf("\n");
}

void print_fapi_vendor_dci_pdu_t( fapi_vendor_dci_pdu_t* dci_pdu) {
    if (dci_pdu == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
    ...
    print_fapi_vendor_dl_pdcch_pdu_t(&dci_pdu->pdcch_pdu_config);
    printf("\n");
}

void print_fapi_vendor_ul_dci_req_t( fapi_vendor_ul_dci_req_t* ul_dci_req) {
    if (ul_dci_req == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
    ...
    for (int i = 0; i < ul_dci_req->num_pdus; ++i) {
        printf("pdus[%d]:\n", i);
        print_fapi_vendor_dci_pdu_t(&ul_dci_req->pdus[i]);
    }
    printf("\n");
}

void print_fapi_vendor_tx_data_req_t( fapi_vendor_tx_data_req_t* tx_data_req) {
    if (tx_data_req == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
...
void print_fapi_vendor_p7_msg_t( fapi_vendor_p7_msg_t* p7_msg) {
    if (p7_msg == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
    printf("fapi_vendor_p7_msg_t \n");
    print_fapi_vendor_dl_tti_req_t(&p7_msg->dl_tti_req);
    print_fapi_vendor_ul_tti_req_t(&p7_msg->ul_tti_req);
    print_fapi_vendor_ul_dci_req_t(&p7_msg->ul_dci_req);
    print_fapi_vendor_tx_data_req_t(&p7_msg->tx_data_req);
    printf("\n");
}

void print_fapi_vendor_msg_t( fapi_vendor_msg_t* vendor_msg) {
    if (vendor_msg == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
    ...
    print_fapi_config_req_vendor_msg_t(&vendor_msg->config_req_vendor);
    print_fapi_start_req_vendor_msg_t(&vendor_msg->start_req_vendor);
    print_fapi_stop_req_vendor_msg_t(&vendor_msg->stop_req_vendor);
    print_fapi_vendor_p7_msg_t(&vendor_msg->p7_req_vendor);
    printf("\n");
}

void print_fapi_vendor_ext_shutdown_req_t( fapi_vendor_ext_shutdown_req_t* shutdown_req) {
...
void print_fapi_vendor_ext_shutdown_res_t( fapi_vendor_ext_shutdown_res_t* shutdown_res) {
...
void print_fapi_vendor_ext_snr_t( fapi_vendor_ext_snr_t* snr) {
    if (snr == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
...
void print_fapi_vendor_ext_srs_pdu_t( fapi_vendor_ext_srs_pdu_t* srs_pdu) {
    if (srs_pdu == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
...
void print_fapi_vendor_ext_srs_ind_t( fapi_vendor_ext_srs_ind_t* srs_ind) {
    if (srs_ind == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
    ...
    for (int i = 0; i < srs_ind->num_pdus; ++i) {
        printf("srs_pdus[%d]:\n", i);
        print_fapi_vendor_ext_srs_pdu_t(&srs_ind->srs_pdus[i]);
    }
    printf("\n");
}

void print_fapi_vendor_ext_slot_ind_t( fapi_vendor_ext_slot_ind_t* slot_ind) {
    if (slot_ind == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
...
void print_fapi_vendor_ext_rx_data_ind_t( fapi_vendor_ext_rx_data_ind_t* rx_data_ind) {
    if (rx_data_ind == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
...
void print_fapi_vendor_ext_crc_ind_t( fapi_vendor_ext_crc_ind_t* crc_ind) {
    if (crc_ind == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
...
void print_fapi_vendor_ext_uci_ind_t( fapi_vendor_ext_uci_ind_t* uci_ind) {
    if (uci_ind == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
...
void print_fapi_vendor_p7_ind_msg_t(fapi_vendor_p7_ind_msg_t* msg) 
{
    if (msg== NULL) {
        printf("Error == Null pointer received.\n");
        return;
   ...
   print_fapi_vendor_ext_snr_t(&msg->crc_snr);
   print_fapi_vendor_ext_snr_t(&msg->uci_snr);
   print_fapi_vendor_ext_srs_ind_t(&msg->srs_ind);
   print_fapi_vendor_ext_slot_ind_t(&msg->slot_ind);
   print_fapi_vendor_ext_rx_data_ind_t(&msg->rx_data_ind);
   print_fapi_vendor_ext_crc_ind_t(&msg->crc_ind);
   print_fapi_vendor_ext_uci_ind_t(&msg->uci_ind);
     
}

#ifdef DEBUG_MODE
void print_fapi_vendor_ext_iq_samples_info_t( fapi_vendor_ext_iq_samples_info_t* iq_samples_info) {
...
void print_fapi_vendor_ext_iq_samples_req_t( fapi_vendor_ext_iq_samples_req_t* req) {
    if (req == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
    ...
    print_fapi_vendor_ext_iq_samples_info_t(&req->iq_samples_info);
}

void print_fapi_vendor_ext_dl_iq_samples_res_t( fapi_vendor_ext_dl_iq_samples_res_t* res) {
    if (res == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    }
...
void print_fapi_vendor_ext_ul_iq_samples_res_t( fapi_vendor_ext_ul_iq_samples_res_t* res) 
{
    if (res == NULL) {
        printf("Error == Null pointer received.\n");
        return;
...
void print_fapi_vendor_ext_start_response_t( fapi_vendor_ext_start_response_t* res) 
{
    if (res == NULL) {
        printf("Error == Null pointer received.\n");
        return;
...
void print_fapi_vendor_ext_add_remove_core_info_t( fapi_vendor_ext_add_remove_core_info_t* info) 
{
    if (info == NULL) {
        printf("Error == Null pointer received.\n");
        return;
...
void print_fapi_vendor_ext_add_remove_core_msg_t( fapi_vendor_ext_add_remove_core_msg_t* msg) 
{
    if (msg == NULL) {
        printf("Error == Null pointer received.\n");
        return;
    ...
    decode_fapi_msg(&msg->header);
    print_fapi_vendor_ext_add_remove_core_info_t(&msg->add_remove_core_info);
}
#endif
